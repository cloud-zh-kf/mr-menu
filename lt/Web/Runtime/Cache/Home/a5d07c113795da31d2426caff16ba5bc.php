...
<body>
     ...
     <div class="h_man">
          <div class="wp">
               <div class="h_tit">
                    <h4 class="tit tc green">Introduzione al prodotto</h4>
               </div>
               <!-- MOBILE ONLINE ORDER -->
                              ...
                              <div class="des">
                                   ...
                                   <div class="mandiv">
                                        ...
                                        <a href="<?php echo get_url($v['id'],'List','video');?>" class="hsbtn sbtn  btn sbtn_orange rd40"><span
                                                  class="val">AI DINE-IN ASSISTENTE</span>
                                             <span class="icon iconfont icon-play_go"></span></a>
                                        <a href="index.php?m=&c=List&a=Mobile&pid=1&ty=34&tty=0" class="hsbtn sbtn sbtn_green rd40">prova la demo</a>
                                   </div>
                              </div>
                         </div>
                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
               ...
               <?php $_result=get_news(35,37,0,0,'*',1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="hmItem hmItem2">
                    ...
                    <div class="wrap">
                         ...
                         <div class="mandiv mt10">
                              <a href="index.php?m=&c=List&a=Website&pid=35&ty=37&tty=0" class="hsbtn sbtn sbtn_green rd40">prova la demo</a>
                         </div>
                    </div>
               </div><?php endforeach; endif; else: echo "" ;endif; ?>
               <!-- APP Introduction -->
               ...
               <div class="hmItem hmItem3">
                    ...
                    <div class="wrap">
                         ...
                         <div class="mandiv mt30 tc">
                              <a href="#xz" class="hsbtn sbtn sbtn_orange rd40">scarica app</a>
                              <a href="index.php?m=&c=List&a=App&pid=39&ty=40&tty=0" class="hsbtn sbtn sbtn_green rd40">conosci altro</a>
                         </div>
                    </div>
               </div>
          ...
          <div class="wp">
               ...
               <div class="wrap ">
                    ...
                    <div class="morediv tc">
                         <a href="index.php?m=&c=List&a=favorabl&pid=23&ty=29&tty=0" class="sbtn sbtn_green_s btn"><span class="val">Più</span><i
     ...
     <div class="h_join bcover" style="background-image: url(./images/h_join_Bg.jpg);">
          <div class="wp">
               ...
               <div class="wrap mt100">
                    <div class="mandiv">
                         <a href="javascript:;" class="messbtn hsbtn sbtn sbtn_green rd40">Conoscenza di cooperazione</a>
                    </div>
               </div><?php endforeach; endif; else: echo "" ;endif; ?>
          </div>
     </div>
     ...
     <div class="h_pos">
          <div class="wp">
               ...
               <div class="wrap">
                    ...
                    <div class="mandiv tc">
                         <a href="index.php?m=&c=List&a=Partner&pid=45&ty=46&tty=0" class="sbtn sbtn_green_s btn"><span class="val">Più</span><i
                              class="iconfont icon-round-arrow_right_al"></i></a>
                    </div>
               </div>
          </div>
