...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_31731__=1;$__FOR_END_31731__=$imgnum;for($i=$__FOR_START_31731__;$i < $__FOR_END_31731__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
...
<body>
    ...
    <div id="usual1" class="usual"> 
		...
		<div class="itab">
			<ul> 
			<li><a href="#tab1" class="selected"><?php echo get_sort_zd($v['ty']);?></a></li> 
			</ul>
		</div> 
		...
		<li><label>信息标题<b>*</b></label><input name="title" type="text" class="dfinput" value='<?php if($v["title"] != ''): echo ($v["title"]); else: echo get_sort_zd($v['ty']); endif; ?>' style="width:518px;"/>
		...
		<?php if(in_array(10,$arr)): $__FOR_START_176__=1;$__FOR_END_176__=$imgnum;for($i=$__FOR_START_176__;$i < $__FOR_END_176__;$i+=1){ $zd="img$i"; ?>
		...
		<?php if(in_array(11,$arr)): ?><li><label>视频上传<b>*</b></label><input type="text" name="file1" id="file1" value="<?php echo ($v["file1"]); ?>" class="dfinput"/> <input type="button" id="insert_file1" value="选择文件" class="btn" /> <font color="#FF0000">文件大小:<?php echo get_cfg_var("post_max_size");?></font></li><?php endif; ?>
