...
<script>
    ...
    <?php $__FOR_START_159069907__=1;$__FOR_END_159069907__=$v['imgnum'];for($i=$__FOR_START_159069907__;$i < $__FOR_END_159069907__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
	...
	<div class="layui-body">
		<div class="layui-tab layui-tab-brief" lay-filter="tab">
			<ul class="layui-tab-title">
				<li><a href="<?php echo ($v["listurl"]); ?>"><?php echo ($v["catname"]); ?></a></li>
				<li class="layui-this"><a href="<?php echo ($v["addurl"]); ?>"><?php echo ($v["catname"]); ?>添加</a></li>
			</ul>
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<form action="" method="post" class="layui-form" lay-filter="content" id="edit">
						...
						<?php if($v['pid'] == 3): ?><div class="layui-form-item">
								<label class="layui-form-label">Set up fee</label>
								<div class="layui-input-inline">
									<input type="number" name="tags" value="<?php echo ($v["tags"]); ?>" placeholder="请输入Set up fee" class="layui-input">
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">符号</label>
								<div class="layui-input-inline">
									<input type="text" name="author" value="<?php echo ($v["author"]); ?>" placeholder="请输入符号" class="layui-input">
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">Monthly fee</label>
								<div class="layui-input-inline">
									<input type="text" name="introduce" value="<?php echo ($v["introduce"]); ?>" placeholder="请输入Monthly fee" class="layui-input">
								</div>
							</div><?php endif; ?>
						...
						<?php if(in_array(10,$arr)): $__FOR_START_1059525604__=1;$__FOR_END_1059525604__=$v['imgnum'];for($i=$__FOR_START_1059525604__;$i < $__FOR_END_1059525604__;$i+=1){ $zd="img$i";?>
								<div class="layui-form-item">
