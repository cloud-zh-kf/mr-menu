		...
		<div class="layui-tab layui-tab-brief" lay-filter="tab">
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<form action="/Admin-Manager-Person" method="post" class="layui-form" onSubmit="return check_person(this);">

						<div class="layui-form-item">
							<label class="layui-form-label">姓名</label>
							<div class="layui-input-inline">
								<input type="text" name="realname" value="<?php echo ($v["realname"]); ?>" placeholder="请输入姓名" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="realname" value="<?php echo ($v["username"]); ?>" class="layui-input" readonly>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="password" name="renewpwd" required lay-verify="required" placeholder="确认密码" autocomplete="off" class="layui-input">
							</div>
						</div>
