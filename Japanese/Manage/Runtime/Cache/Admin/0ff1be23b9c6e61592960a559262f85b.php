...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_17824__=1;$__FOR_END_17824__=$imgnum;for($i=$__FOR_START_17824__;$i < $__FOR_END_17824__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
...
<body>
	...
	<ul class="forminfo">
		...
		<?php if(in_array(9,$arr)): ?><li><label>内容详情<b>*</b></label><textarea class="editor_id" name="content" style="width:667px;height:350px;"></textarea></li><?php endif; ?>
		
		<?php if(in_array(10,$arr)): $__FOR_START_5465__=1;$__FOR_END_5465__=$imgnum;for($i=$__FOR_START_5465__;$i < $__FOR_END_5465__;$i+=1){ ?><li><label><?php echo get_imgname($i,$v['pid'],$v['ty'],$v['tty']);?><b>*</b></label><input type="text" name="img<?php echo ($i); ?>" id="img<?php echo ($i); ?>" value="" class="dfinput"/> <input type="button"
		...
		<?php if(in_array(12,$arr)): ?><li><label>导演<b>*</b></label><input name="source" type="text" value="" class="dfinput"></li><?php endif; ?>
		
		<?php if(in_array(13,$arr)): ?><li><label>主演<b>*</b></label><input name="author" type="text" value="" class="dfinput"></li><?php endif; ?>
