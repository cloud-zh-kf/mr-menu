...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_409__=1;$__FOR_END_409__=$imgnum;for($i=$__FOR_START_409__;$i < $__FOR_END_409__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
...
<body>
	...
	<ul class="forminfo">
		...
		<select name="fid" >
 		<?php if(is_array($artlist)): $i = 0; $__LIST__ = $artlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><option value="<?php echo ($s["id"]); ?>"><?php echo ($s["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		</select>
		</li>
		
		<li><label>作品名称<b>*</b></label><input name="title" type="text" class="dfinput" value="" style="width:518px;"/>
		...
		<?php if(in_array(2,$arr)): ?><li><label>信息标签<b>*</b></label><input name="tags" type="text" value="" class="dfinput" style="width:518px;"></li><?php endif; ?>

		<?php if(in_array(5,$arr)): ?><li><label>外部链接<b>*</b></label><input name="linkurl" type="text" value="" class="dfinput" style="width:518px;"></li><?php endif; ?>
		
		<?php if(in_array(6,$arr)): ?><li><label>内容摘要<b>*</b></label><textarea name="introduce" style="width:520px;height:100px;" class="dfinput"></textarea></li><?php endif; ?>
		
		<?php if(in_array(7,$arr)): ?><li><label>SEO关键字<b>*</b></label><input name="seokeywords" type="text" value="" class="dfinput" style="width:518px;"></li><?php endif; ?>
		...
		<?php if(in_array(9,$arr)): ?><li><label>作品详情<b>*</b></label><textarea class="editor_id" name="content" style="width:667px;height:350px;"></textarea></li><?php endif; ?>
		
		<?php if(in_array(10,$arr)): $__FOR_START_31838__=1;$__FOR_END_31838__=$imgnum;for($i=$__FOR_START_31838__;$i < $__FOR_END_31838__;$i+=1){ ?><li><label><?php echo get_imgname($i,$list['pid'],$list['ty'],$list['tty']);?><b>*</b></label><input type="text" name="img<?php echo ($i); ?>" id="img<?php echo ($i); ?>" value="" class="dfinput"/> <input type="button" 
		...
		<?php if(in_array(11,$arr)): ?><li><label>文件上传<b>*</b></label><input type="text" name="file1" id="file1" value="" class="dfinput"/> <input type="button" id="insert_file1" value="选择文件" class="btn" /> <font color="#FF0000">文件大小:<?php echo get_cfg_var("post_max_size");?></font></li><?php endif; ?>
 		...
 		<?php if(in_array(14,$arr)): ?><li><label>价格<b>*</b></label><input name="price" type="text" value="" class="dfinput"></li><?php endif; ?>
