...
<script>
    ...
    <?php $__FOR_START_4642__=1;$__FOR_END_4642__=$v['imgnum'];for($i=$__FOR_START_4642__;$i < $__FOR_END_4642__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<form action="" method="post" class="layui-form" lay-filter="content" id="edit">
						...
						<?php if(in_array(10,$arr)): $__FOR_START_25614__=1;$__FOR_END_25614__=$v['imgnum'];for($i=$__FOR_START_25614__;$i < $__FOR_END_25614__;$i+=1){ $zd="img$i";?>
