	...
	<div class="layui-body">
		<div class="layui-tab layui-tab-brief" lay-filter="tab">
			<ul class="layui-tab-title">
				<li><a href="<?php echo U(CONTROLLER_NAME.'/Index');?>"><?php echo get_forms_zd(I('request.typeid','title'))?>表管理</a></li>
				<li class="layui-this"><a href="<?php echo U('Forms/Add');?>">字段添加</a></li>
			</ul>
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<form action="/en/jxadmin.php/Admin-Forms-InfoAdd" method="post" class="layui-form" onSubmit="return check_myforms(this);">
						<input type="hidden" name="typeid" value="<?php echo I('get.typeid');?>">
						<?php $_result=get_list_myfields_list(I('request.typeid'));if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 2 );++$i;?><div class="layui-form-item">
								<label class="layui-form-label"><?php echo ($vs["title"]); ?></label>
								<div class="layui-input-inline">
									<input type="text" name="<?php echo ($vs["Field"]); ?>" <?php if($vs['tip']){?>lay-verify="required"<?php }?> placeholder="<?php echo ($vs["tip"]); ?>" class="layui-input">
								</div>
...
<script>
    ...
    <?php $_result=get_js_myfields_list(I('request.typeid'));if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 2 );++$i; echo ($vs["js"]); endforeach; endif; else: echo "" ;endif; ?>
    }
</script>
