...
<script>
    ...
    <?php $__FOR_START_2214__=1;$__FOR_END_2214__=$v['imgnum'];for($i=$__FOR_START_2214__;$i < $__FOR_END_2214__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<form action="" method="post" class="layui-form" lay-filter="content" id="edit">
						...
						<?php if(in_array(10,$arr)): $__FOR_START_29415__=1;$__FOR_END_29415__=$v['imgnum'];for($i=$__FOR_START_29415__;$i < $__FOR_END_29415__;$i+=1){ $zd="img$i";?>
						...
						<?php if(in_array(11,$arr)): ?><div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="text" name="file1" value="<?php echo ($v["file1"]); ?>" placeholder="请选择文件上传" class="layui-input">
								</div>
						...
						<?php if(in_array(14,$arr)): ?><div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="text" name="price" value="<?php echo ($v["price"]); ?>" placeholder="请输入联系方式" class="layui-input">
								</div>
							</div><?php endif; ?>
