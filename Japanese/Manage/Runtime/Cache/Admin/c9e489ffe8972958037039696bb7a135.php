	...
	<div class="layui-body">
		<div class="layui-tab layui-tab-brief" lay-filter="tab">
			<ul class="layui-tab-title">
				<li><a href="<?php echo U('Forms/Index');?>">表单管理</a></li>
				<li class="layui-this"><a href="<?php echo U('Forms/Add');?>">表单添加</a></li>
			</ul>
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<form action="/en/jxadmin.php/Admin-Forms-Add" method="post" class="layui-form" onSubmit="return check_forms(this);">
						<input type="hidden" name="id" value="<?php echo ($v['id']); ?>">
						<div class="layui-form-item">
							<label class="layui-form-label">名称</label>
							<div class="layui-input-inline">
								<input type="text" name="title" value="<?php echo ($v['title']); ?>" lay-verify="required" placeholder="请输入中文名称" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="tablename" value="<?php echo ($v['tablename']); ?>" lay-verify="required" placeholder="请输入只支持字母" class="layui-input">
							</div>
						</div>
