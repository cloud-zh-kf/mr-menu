...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_14676__=1;$__FOR_END_14676__=$imgnum;for($i=$__FOR_START_14676__;$i < $__FOR_END_14676__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
...
<body>
	...
	<ul class="forminfo">
		...
		<li><label>姓名<b>*</b></label><input name="title" type="text" class="dfinput" value="<?php echo ($v["title"]); ?>"/>
		...
		<?php if(in_array(2,$arr)): ?><li><label>职务<b>*</b></label><input name="tags" type="text" value="<?php echo ($v["tags"]); ?>" class="dfinput"></li><?php endif; ?>

		<?php if(in_array(12,$arr)): ?><li><label>标签<b>*</b></label><input name="source" type="text" value="<?php echo ($v["source"]); ?>" class="dfinput"></li><?php endif; ?>
		...
		<?php if(in_array(10,$arr)): $__FOR_START_12541__=1;$__FOR_END_12541__=$imgnum;for($i=$__FOR_START_12541__;$i < $__FOR_END_12541__;$i+=1){ ?><li><label><?php echo get_imgname($i,$v['pid'],$v['ty'],$v['tty']);?><b>*</b></label><input type="text" name="img<?php echo ($i); ?>" id="img<?php echo ($i); ?>" value="" class="dfinput"/> <input type="button"
