...
<head>
	...
	<link rel="stylesheet" href="<?php echo (ADMIN_PUBLIC); ?>/layui/css/layui.css?V2.3.0">
	<link rel="stylesheet" href="<?php echo (ADMIN_PUBLIC); ?>/font-awesome/css/font-awesome.min.css?V4.7.0" type="text/css">
	<link rel="stylesheet" href="<?php echo (ADMIN_PUBLIC); ?>/css/login.css?V1.1.6">
...
<div class="user-login" >
	<div class="user-login-main">
		...
		<form action="<?php echo U(CONTROLLER_NAME.'/Action');?>"  onsubmit="return false" class="layui-form" id="dologin">
...
<script type="text/javascript" src="<?php echo (ADMIN_PUBLIC); ?>/layui/layui.all.js?V2.3.0"></script>
<script type="text/javascript" src="<?php echo (ADMIN_PUBLIC); ?>/js/mylayui.js?V1.1.6"></script>
<script type="text/javascript" src="<?php echo (ADMIN_PUBLIC); ?>/js/md5.js"></script>
<!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
<!--[if lt IE 9]>
