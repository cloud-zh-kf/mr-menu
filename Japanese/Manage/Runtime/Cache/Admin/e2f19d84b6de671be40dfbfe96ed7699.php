...
<script>
    ...
    <?php $__FOR_START_30320__=1;$__FOR_END_30320__=$v['imgnum'];for($i=$__FOR_START_30320__;$i < $__FOR_END_30320__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
	...
	<div class="layui-body">
		<div class="layui-tab layui-tab-brief" lay-filter="tab">
			<ul class="layui-tab-title">
				<li><a href="<?php echo U('Case/Index');?>">案例详情内容</a></li>
				<li class="layui-this"><a href="<?php echo U('Case/Add');?>">案例详情内容</a></li>
			</ul>
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<form action="" method="post" class="layui-form" lay-filter="content" id="edit">
						...
						<?php if(in_array(10,$arr)): $__FOR_START_7761__=1;$__FOR_END_7761__=$v['imgnum'];for($i=$__FOR_START_7761__;$i < $__FOR_END_7761__;$i+=1){ $zd="img$i"; ?>
								<div class="layui-form-item">
									...
									<font color="red">图片大小:<?php echo get_cfg_var("post_max_size");?>内,图片尺寸：<?php echo $v['imgsize'][$i-1];?>px</font>
								</div><?php } endif; ?>
