...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_5449__=1;$__FOR_END_5449__=$imgnum;for($i=$__FOR_START_5449__;$i < $__FOR_END_5449__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
...
<body>
    ...
    <div id="usual1" class="usual"> 
		...
		<ul class="forminfo">
		<form name="formlist" method="post" action="<?php echo U(CONTROLLER_NAME.'/Update');?>" onSubmit="return check_manager_add(this);" enctype="multipart/form-data">
		<input type="hidden" name="id" value="<?php echo ($v["id"]); ?>">
		<li><label>姓名<b>*</b></label><input name="title" type="text" class="dfinput" value="<?php echo ($v["title"]); ?>" style="width:518px;"/>
		...
		<li><label>昵称<b>*</b></label><input name="seotitle" type="text" value="<?php echo ($v["seotitle"]); ?>" class="dfinput" /></li>

		<li><label>生日<b>*</b></label><input name="tags" type="text" value="<?php echo ($v["tags"]); ?>" class="dfinput"/></li>	

		<li><label>星座<b>*</b></label><input name="linkurl" type="text" value="<?php echo ($v["linkurl"]); ?>" class="dfinput"/></li>	
		
		<li><label>民族<b>*</b></label><input name="source" type="text" value="<?php echo ($v["source"]); ?>" class="dfinput"/></li>	
		
		<li><label>身高<b>*</b></label><input name="author" type="text" value="<?php echo ($v["author"]); ?>" class="dfinput"/></li>	
		
		<li><label>毕业院校<b>*</b></label><input name="content" type="text" value="<?php echo ($v["content"]); ?>" class="dfinput"/></li>	
		
		<li><label>简介<b>*</b></label><textarea name="introduce" style="width:520px;height:100px;" class="dfinput"><?php echo ($v["introduce"]); ?></textarea></li>  			
		
		<?php if(in_array(10,$arr)): $__FOR_START_32334__=1;$__FOR_END_32334__=$imgnum;for($i=$__FOR_START_32334__;$i < $__FOR_END_32334__;$i+=1){ $zd="img$i"; ?>
