          ...
          <td>
			...
			<select name="typeid">
				<option value="0">请选择</option>
 				<option value="1" <?php if(I('get.typeid') == 1): ?>selected<?php endif; ?>>升级VIP会员</option>
 				<option value="5" <?php if(I('get.typeid') == 5): ?>selected<?php endif; ?>>置顶展示</option>
 				<option value="6" <?php if(I('get.typeid') == 6): ?>selected<?php endif; ?>>推荐展示</option>
 				<option value="7" <?php if(I('get.typeid') == 7): ?>selected<?php endif; ?>>模特预约定金</option>
 				<option value="8" <?php if(I('get.typeid') == 8): ?>selected<?php endif; ?>>发布通告审核定金</option>
 			</select>	
    ...
    <div class="rightinfo">
		...
		<div class="tools">
 		...
 		<table class="tablelist">
			...
			<td><?php if($v['zid'] == 0): ?>支付宝<?php elseif($v['zid'] == 1): ?>微信<?php elseif($v['zid'] == 2): ?>网上银行<?php elseif($v['zid'] == 3): ?>余额<?php endif; ?></td>
