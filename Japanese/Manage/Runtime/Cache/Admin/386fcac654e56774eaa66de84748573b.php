...
<body>
	...
	<div class="place">
		...
		<li><a href="<?php echo U(CONTROLLER_NAME.'/Index');?>">评价管理</a></li>
		<li>信息列表</li>
		</ul>
    </div>
	...
	<table class="tablelist">
	 <form action="" method="get" name="formlists">
     	<thead>
  		<tr>
          <td>
   		  <b>评价标题：</b><input name="title" type="text" class="dfinput" value="<?php echo ($_GET['title']); ?>"/>
	...
	<form name="formlist" method="post" action="<?php echo U(CONTROLLER_NAME.'/Del');?>">
		...
		<table class="tablelist">
			<thead>
				...
				<th width="50px">选择</th>
				<th width="50px">序号</th>
				<th width="140px">评价用户</th>
				<th width="140px">被评价模特</th>
				<th width="140px">评价标题</th>
				<th>评价内容</th>
				<th width="50px">状态</th>
