...
<script>
    ...
    <?php $__FOR_START_46638271__=1;$__FOR_END_46638271__=$v['imgnum'];for($i=$__FOR_START_46638271__;$i < $__FOR_END_46638271__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
 			...
 			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<form action="" method="post" class="layui-form" lay-filter="content" id="edit">
						...
						<?php if(in_array(10,$arr)): $__FOR_START_1394833813__=1;$__FOR_END_1394833813__=$v['imgnum'];for($i=$__FOR_START_1394833813__;$i < $__FOR_END_1394833813__;$i+=1){ $zd="img$i";?>
