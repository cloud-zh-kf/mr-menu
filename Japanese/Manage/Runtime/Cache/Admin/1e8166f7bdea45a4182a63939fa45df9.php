...
<body>
	...
	<div class="place">
		...
		<li><a href="<?php echo U(CONTROLLER_NAME.'/Index');?>">在线留言管理</a></li>
		<li>信息列表</li>
		</ul>
    </div>
	...
	<table class="tablelist">
	 <form action="" method="get" name="formlists">
     	<thead>
  		<tr>
          <td>
   		  <b>姓名：</b><input name="realname" type="text" class="dfinput" value="<?php echo ($_GET['realname']); ?>" style="width:100px;"/>
  		  <b>电话：</b><input name="phone" type="text" class="dfinput" value="<?php echo ($_GET['phone']); ?>" style="width:200px;"/>
