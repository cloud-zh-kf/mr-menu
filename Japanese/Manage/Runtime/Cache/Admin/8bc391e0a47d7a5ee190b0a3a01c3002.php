...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_13245__=1;$__FOR_END_13245__=$imgnum;for($i=$__FOR_START_13245__;$i < $__FOR_END_13245__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
...
<body>
    ...
    <div id="usual1" class="usual"> 
		...
		<?php if(in_array(10,$arr)): $__FOR_START_19890__=1;$__FOR_END_19890__=$imgnum;for($i=$__FOR_START_19890__;$i < $__FOR_END_19890__;$i+=1){ $zd="img$i"; ?>
		...
		<?php if(in_array(11,$arr)): ?><li><label>文件上传<b>*</b></label><input type="text" name="file1" id="file1" value="<?php echo ($v["file1"]); ?>" class="dfinput"/> <input type="button" id="insert_file1" value="选择文件" class="btn" /> <font color="#FF0000">文件大小:<?php echo get_cfg_var("post_max_size");?></font></li><?php endif; ?>
		
		<?php if(in_array(12,$arr)): ?><li><label>导演<b>*</b></label><input name="source" type="text" value="<?php echo ($v["source"]); ?>" class="dfinput"></li><?php endif; ?>
		
		<?php if(in_array(13,$arr)): ?><li><label>主演<b>*</b></label><input name="author" type="text" value="<?php echo ($v["author"]); ?>" class="dfinput"></li><?php endif; ?>
