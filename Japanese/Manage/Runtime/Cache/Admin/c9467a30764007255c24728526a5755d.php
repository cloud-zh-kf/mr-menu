...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_28220__=1;$__FOR_END_28220__=$imgnum;for($i=$__FOR_START_28220__;$i < $__FOR_END_28220__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
...
<body>
    ...
    <div id="usual1" class="usual"> 
		...
		<?php if(in_array(10,$arr)): $__FOR_START_26565__=1;$__FOR_END_26565__=$imgnum;for($i=$__FOR_START_26565__;$i < $__FOR_END_26565__;$i+=1){ $zd="img$i"; ?>
