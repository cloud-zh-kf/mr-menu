...
<body>
	...
	<form name="formlist" method="post" action="">
		...
		<table class="tablelist">
			...
			<td>
			<?php
 $cname=get_zd_name('catname','sort','id='.$v['ttty'].''); if($cname) echo "<font color=red>[{$cname}]</font>";else echo ''; ?>
			<?php echo ($v["title"]); ?> <?php if($v['isgood'] == 1): ?><font color="red">推荐</font><?php endif; ?> <?php if($v['istop'] == 1): ?><font color="blue">置顶</font><?php endif; ?></td>
			<td>
