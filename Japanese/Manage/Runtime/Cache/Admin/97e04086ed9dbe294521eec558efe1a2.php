...
<body>
	...
	<ul class="forminfo">
		...
		<li><label>消息标题<b>*</b></label><input name="title" type="text" class="dfinput" value="" style="width:518px;"/></li>

		<li><label>消息内容<b>*</b></label><textarea name="content" style="width:520px;height:100px;" class="dfinput"></textarea></li>
