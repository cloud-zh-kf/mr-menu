...
<body>
    ...
    <li><a href="<?php echo U(CONTROLLER_NAME.'/Index');?>">优惠券管理</a></li>
    <li>优惠券添加</li>
	</ul>
    </div>
    ...
    <div class="itab">
		<ul> 
		<li><a href="#tab1" class="selected">优惠券添加</a></li> 
		</ul>
    </div> 
  	...
  	<div id="tab1" class="tabson">
		...
		<ul class="forminfo">
			<form name="formlist" method="post" action="<?php echo U(CONTROLLER_NAME.'/Add');?>" onSubmit="return check_coupon_add(this);">
 			<li><label>优惠金额<b>*</b></label><input name="money" type="text" class="dfinput" value="10"/></li>
			<li><label>开始时间<b>*</b></label><input name="sdate" type="text" class="dfinput" value="" onFocus="WdatePicker({lang:'zh-cn'})"/></li>
			<li><label>结束时间<b>*</b></label><input name="edate" type="text" class="dfinput" value="" onFocus="WdatePicker({lang:'zh-cn'})"/></li>
