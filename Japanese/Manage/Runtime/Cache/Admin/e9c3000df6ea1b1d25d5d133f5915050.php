...
<body>
	...
	<div class="place">
		...
		<li><a href="<?php echo U(CONTROLLER_NAME.'/Index');?>">12306账户管理</a></li>
		<li>信息列表</li>
		</ul>
    </div>
	...
	<table class="tablelist">
	 <form action="" method="get" name="formlists">
     	<thead>
  		<tr>
          <td>
   		  <b>微信昵称：</b><input name="nickname" type="text" class="dfinput" value="<?php echo ($_GET['nickname']); ?>" style="width:100px;"/>
   		  <b>用户名：</b><input name="username" type="text" class="dfinput" value="<?php echo ($_GET['username']); ?>" style="width:100px;"/>
