...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_31363__=1;$__FOR_END_31363__=$imgnum;for($i=$__FOR_START_31363__;$i < $__FOR_END_31363__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
  	...
  	<div id="tab1" class="tabson">
		...
		<ul class="forminfo">
			<form name="formlist" method="post" action="<?php echo U(CONTROLLER_NAME.'/Add');?>" onSubmit="return check_goods_add(this);">
 			...
 			<li><label>活动标题<b>*</b></label><input name="title" type="text" class="dfinput" value=""/></li>
        ...
        &nbsp;
			...
			<input name="address" type="text" class="dfinput" value="" placeholder="详细地址" style="width:200px;"/>
			</li>
			<li><label>工作日期<b>*</b></label>开始时间:<input name="starttime" placeholder="点击选择日期" style="width:100px;" type="text" class="dfinput" value="" onFocus="WdatePicker({lang:'zh-cn'})"/>
			结束时间:<input name="endtime" type="text"  style="width:100px;" placeholder="点击选择日期" class="dfinput" value="" onFocus="WdatePicker({lang:'zh-cn'})"/>
			</li>
			<li><label>工作时间<b>*</b></label><input name="worktime" type="text" class="dfinput" value="<?php echo ($v["worktime"]); ?>"/></li>
			<li><label>报名截至<b>*</b></label><input name="overtime" placeholder="点击选择日期" style="width:100px;" type="text" class="dfinput" value="" onFocus="WdatePicker({lang:'zh-cn'})"/></li>
			...
			<li><label>活动坐标<b>*</b></label><input name="ll" type="text" class="dfinput" value="<?php echo ($v["ll"]); ?>"/> <a href="<?php echo U('Activity/Map');?>" style="color:red" target="_blank">获取经纬度</a></li>
 			<li><label>活动详情<b>*</b></label><textarea name="content" style="width:520px;height:200px;" class="dfinput"></textarea></li>
  			<?php $__FOR_START_17408__=1;$__FOR_END_17408__=$imgnum;for($i=$__FOR_START_17408__;$i < $__FOR_END_17408__;$i+=1){ ?><li><label><?php echo get_imgname($i,$list['pid'],$list['ty'],$list['tty']);?><b>*</b></label><input type="text" name="img<?php echo ($i); ?>" id="img<?php echo ($i); ?>" value="" class="dfinput"/> <input type="button" 
