...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_24646__=1;$__FOR_END_24646__=$imgnum;for($i=$__FOR_START_24646__;$i < $__FOR_END_24646__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
...
<body>
    ...
    <div id="usual1" class="usual"> 
		...
		<?php if(in_array(10,$arr)): $__FOR_START_519__=1;$__FOR_END_519__=$imgnum;for($i=$__FOR_START_519__;$i < $__FOR_END_519__;$i+=1){ $zd="img$i"; ?>
