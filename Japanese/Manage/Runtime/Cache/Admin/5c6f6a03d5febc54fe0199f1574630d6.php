...
<div class="layui-side layui-bg-black">
	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
		<ul class="layui-tab-title">
			<li class="layui-this"><a href="<?php echo U('Sort/Index');?>">栏目列表</a></li>
			<?php if($_SESSION['admin_id']== 99999999): ?><li><a href="<?php echo U('Sort/Add');?>">栏目添加</a></li><?php endif; ?>
		</ul>
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show">
				<form action="/Japanese/jxadmin.php/Admin-Sort-Index" method="post" id="sortForm" name="sortForm">
				<table class="layui-table">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
							...
							<td class="table-input">
								...
								<input type="text" name="sorting[]" value="<?php echo ($v['disorder']); ?>" class="layui-input"></td>
							<td>
								<?php if($v['status']==1){?>
								<a href='<?php echo get_url($v['id'],'Sort','Audit');?>'><i class='fa fa-toggle-on' title="点击关闭"></i></a>
								<?php }else{?>
								<a href='<?php echo get_url($v['id'],'Sort','Audit');?>'><i class='fa fa-toggle-off' title="点击开启"></i></a>
								<?php }?>
							</td>
							...
							<td>
								...
								<?php if($v['isopen']==1||session('admin_id')==99999999){?>
									<a href="<?php echo U(CONTROLLER_NAME.'/Add',"pid=".$v['id']."");?>" class='layui-btn layui-btn-xs'>添加子栏目</a>
								...
								<?php }?>
								<a href='<?php echo get_url($v['id'],'Sort','Add');?>'  class='layui-btn layui-btn-xs layui-btn-danger'>修改</a>
							</td>
