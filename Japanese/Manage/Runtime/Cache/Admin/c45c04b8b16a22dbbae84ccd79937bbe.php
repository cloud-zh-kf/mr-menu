...
<body>
	...
	<div class="place">
		...
		<li><a href="<?php echo U(CONTROLLER_NAME.'/Index');?>">提现管理</a></li>
		<li>信息列表</li>
		</ul>
    </div>
    ...
    <div class="rightinfo">
		...
		<table class="tablelist">
			<thead>
				...
				<th width="50px">选择</th>
				<th width="50px">序号</th>
				<th width="120px">提现用户</th>
				<th width="120px">流水号</th>
				<th width="350px">银行卡</th>
				<th width="80px">提现金额</th>
				<th>备注</th>
				<th width="60px">状态</th>
				<th width="140px">提现时间</th>
				</tr>
			</thead>
			<tbody>
			...
			<td><?php if(($v['ispay']) == "1"): ?><img width="16" height="16" border="0" alt="已审核" src="<?php echo (ADMIN_PUBLIC); ?>/images/p.png"/> 
                 <?php else: ?>
                 <a href="<?php echo U(CONTROLLER_NAME.'/Audit',"id=".$v['id']."");?>"><img width="16" height="16" border="0" alt="待审核" src="<?php echo (ADMIN_PUBLIC); ?>/images/x.png"/></a><?php endif; ?></td>
