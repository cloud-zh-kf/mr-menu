	...
	<div class="layui-body">
		<div class="layui-tab layui-tab-brief" lay-filter="tab">
			<ul class="layui-tab-title">
				<li><a href="javascript:history(-1)">表单管理</a></li>
				<li class="layui-this"><a href="<?php echo U('Forms/Add');?>">字段添加</a></li>
			</ul>
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<form action="/en/jxadmin.php/Admin-Forms-FieldAdd" method="post" class="layui-form" onSubmit="return check_forms(this);">
						<input type="hidden" name="table" value="<?php echo get_forms_zd(I('get.typeid'));?>">
						<input type="hidden" name="typeid" value="<?php echo I('get.typeid');?>">

						<input type="hidden" name="pid" value="<?php echo I('get.typeid');?>">
						<input type="hidden" name="oldname" value="<?php echo I('get.zd');?>">
						<input type="hidden" name="act" value="<?php echo I('get.act');?>">

						<div class="layui-form-item">
							<label class="layui-form-label">字段标题</label>
							<div class="layui-input-inline">
								<input type="text" name="title" value="<?php echo I('get.title');?>" lay-verify="required" placeholder="左侧文字" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="name" value="<?php echo I('get.zd');?>" lay-verify="required" placeholder="只支持字母" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<label class="layui-form-label">字段名称</label>
							<div class="layui-input-inline">
								<input type="text" name="tip" value="<?php echo I('get.tip');?>" lay-verify="required" placeholder="只当该字段为必填时则填写" class="layui-input">
							</div>
						</div>
