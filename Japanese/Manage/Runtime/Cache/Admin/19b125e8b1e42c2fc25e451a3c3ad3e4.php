	...
	<div class="layui-body">
		<div class="layui-tab layui-tab-brief" lay-filter="tab">
			...
			<ul class="layui-tab-title">
				<li class="layui-this"><a href="javascript:;" class="btach" type="1">数据备份</a></li>
				<li><a href="<?php echo U('Backup/Import');?>" class="btachs">还原数据</a></li>
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<table class="layui-table">
						...
						<thead>
						<tr>
							<th><input type="checkbox" name="all" onClick="CheckAll(this);" class="checkbox" title="全选" checked> 全选</th>
							<th>表名</th>
							<th>数量</th>
							<th>大小</th>
							<th>创建时间</th>
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
								<td><input name="id" type="checkbox" value="<?php echo ($v["Name"]); ?>" checked></td>
								<td><?php echo ($v["Name"]); ?></td>
								<td><?php echo ($v["Rows"]); ?></td>
								<td><?php echo (formatbytes($v["Data_length"])); ?></td>
								<td><?php echo ($v["Create_time"]); ?></td>
								<td>
									<a href="javascript:;" type="2" data-name="<?php echo ($v["Name"]); ?>" class='do layui-btn layui-btn-xs layui-btn-danger' title='优化表'>优化表</a>
									<a href="javascript:;" type="3" data-name="<?php echo ($v["Name"]); ?>" class='do layui-btn layui-btn-xs' title='修复表'>修复表</a>
								</td>
