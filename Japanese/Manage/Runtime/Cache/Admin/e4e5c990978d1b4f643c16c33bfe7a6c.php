...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_1118__=1;$__FOR_END_1118__=$imgnum;for($i=$__FOR_START_1118__;$i < $__FOR_END_1118__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
...
<body>
	...
	<ul class="forminfo">
		...
		<?php if(in_array(2,$arr)): ?><li><label>下载次数<b>*</b></label><input name="tags" type="text" value="<?php echo ($v["tags"]); ?>" class="dfinput" style="width:518px;"></li><?php endif; ?>
		...
		<?php if(in_array(10,$arr)): $__FOR_START_12351__=1;$__FOR_END_12351__=$imgnum;for($i=$__FOR_START_12351__;$i < $__FOR_END_12351__;$i+=1){ ?><li><label><?php echo get_imgname($i,$v['pid'],$v['ty'],$v['tty']);?><b>*</b></label><input type="text" name="img<?php echo ($i); ?>" id="img<?php echo ($i); ?>" value="" class="dfinput"/> <input type="button"
		...
		<?php if(in_array(12,$arr)): ?><li><label>类型<b>*</b></label><input name="source" type="text" value="<?php echo ($v["source"]); ?>" class="dfinput"></li><?php endif; ?>
		
		<?php if(in_array(13,$arr)): ?><li><label>大小<b>*</b></label><input name="author" type="text" value="<?php echo ($v["author"]); ?>" class="dfinput"></li><?php endif; ?>
