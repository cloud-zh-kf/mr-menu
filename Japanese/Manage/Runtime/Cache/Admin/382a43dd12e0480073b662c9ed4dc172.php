...
<body>
    ...
    <div class="itab">
		<ul> 
		<li><a href="#tab1" class="selected">模块添加</a></li> 
		</ul>
    </div> 
  	...
  	<div id="tab1" class="tabson">
		...
		<ul class="forminfo">
			<form name="formlist" method="post" action="<?php echo U(CONTROLLER_NAME.'/Add');?>" onSubmit="return check_module_add(this);">
			<li><label>模块名称<b>*</b></label><input name="module_name" type="text" class="dfinput" value=""/></li>
			<li><label>所需字段<b>*</b></label><?php echo ($module_fields); ?></li>
			<li><label>控制器<b>*</b></label><input name="module_c" id="module_c" type="text" class="dfinput" value="<?php if($arr['module_id'] == 2): ?>Single<?php else: ?>News<?php endif; ?>"/></li>
			<li><label>操作方法<b>*</b></label><input name="module_a" id="module_a" type="text" class="dfinput" value="Index"/></li>
