...
KindEditor.ready(function(K) {
	...
	<?php $__FOR_START_10428__=1;$__FOR_END_10428__=$imgnum;for($i=$__FOR_START_10428__;$i < $__FOR_END_10428__;$i+=1){ ?>K('#img<?php echo ($i); ?>_btn').click(function() {
...
<body>
    ...
    <div id="usual1" class="usual"> 
		...
		<li><label>职位名称<b>*</b></label><input name="title" type="text" class="dfinput" value="<?php echo ($v["title"]); ?>" style="width:518px;"/>
		...
		<?php if(in_array(2,$arr)): ?><li><label>薪资<b>*</b></label><input name="tags" type="text" value="<?php echo ($v["tags"]); ?>" class="dfinput" style="width:518px;"></li><?php endif; ?>
		...
		<?php if(in_array(6,$arr)): ?><li><label>工作年限<b>*</b></label><input name="introduce" type="text" value="<?php echo ($v["introduce"]); ?>" class="dfinput" style="width:518px;"></li><?php endif; ?>
		...
		<?php if(in_array(10,$arr)): $__FOR_START_20549__=1;$__FOR_END_20549__=$imgnum;for($i=$__FOR_START_20549__;$i < $__FOR_END_20549__;$i+=1){ $zd="img$i"; ?>
