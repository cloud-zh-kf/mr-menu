...
<div class="layui-side layui-bg-black">
	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
		<ul class="layui-tab-title">
			<li class="layui-this"><a href="<?php echo U('Forms/Index');?>">表单管理</a></li>
			<li><a href="<?php echo U('Forms/Add');?>">表单添加</a></li>
		</ul>
				...
				<table class="layui-table">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
								...
								<a href="<?php echo U(CONTROLLER_NAME.'/Infos',"typeid=".$v['id']."");?>" class='layui-btn layui-btn-xs layui-btn-blue' >信息列表</a>
								<a href="<?php echo U(CONTROLLER_NAME.'/Fields',"typeid=".$v['id']."");?>" class='layui-btn layui-btn-xs layui-btn-danger' >管理字段</a>
								<a href="<?php echo get_url($v['id'],'Forms','Add');?>" class='layui-btn layui-btn-xs layui-btn-green' >修改</a>
								<a href='<?php echo get_url($v['id'],'Forms','FormsDel');?>' onclick='return confirm("您确定要删除吗？\n\n删除后不可恢复!")' class='layui-btn layui-btn-xs layui-btn-danger' title='删除'>删除</a>
							</td>
