              ...
              <header  id="mainMenuBar" class="header iheader"><?php endif; ?>
                  <div class="loarea">
                         <div class="wp clearfix">
                              <a class="logo" href="/Japanese/"><img src="<?php echo sys('sys_img1');?>" /></a>
                              <!--PC nav -->
                              <nav class="nav">
                                   <ul class="wp navul">
                                        <li><a <?php echo empty($vpid) ? 'class="act_nav"':''; ?> href="/Japanese/">ホーム</a></li>
                                        ...
                                        <li><a href="javascript:;" <?php echo $vpid==18 ? 'class="act_nav"':''; echo $vpid==35 ? 'class="act_nav"':''; ?>>私たちについて<i class="iconfont icon-down2"></i></a>
                                             <div class="subnav zj">
                                                  <div class="nr">
                                                    <a href="index.php?m=&c=List&a=About&pid=35&ty=37&tty=0" >私たちのビジョン</a>
                                                    <a href="index.php?m=&c=List&a=common&pid=18&ty=21&tty=0" ><?php echo get_sort_zd(21);?></a>
                                                    <a href="index.php?m=&c=List&a=message&pid=18&ty=22&tty=0" >協業について</a>
                                                  </div>
                                             </div>
                                        </li>
                                   </ul>
                              ...
                              <div class="chooseLan rd30">
                                   <div class="curLan">
                                        ...
                                        <span class="val ibvm">日本語</span></div>
                                   <div class="lanLay">
                                        <ul class="lanul cle">
                              ...
                              <div class="inav">
                                   <div class="wrap">
                                        ...
                                        <dl>
                                             ...
                                             <dd>
                                             <h6><a href="index.php?m=&c=List&a=About&pid=35&ty=37&tty=0" >私たちのビジョン</a></h6>
                                             <h6><a href="index.php?m=&c=List&a=common&pid=18&ty=21&tty=0" ><?php echo get_sort_zd(21);?></a></h6>
                                             <h6><a href="index.php?m=&c=List&a=message&pid=18&ty=22&tty=0" >協業について</a></h6>
                                             </dd>
                                        </dl>
                                   </div>
                              </div>
                                        ...
                                        <div class="mandiv">
                                          <!-- popupVideo1 -->
                                             <a href="<?php echo get_url($v['id'],'List','video');?>" class=" sbtn_ban btn rd40">
                                                  <span class="val">Mr. Menuについてもっと知る</span>
    ...
    <div class="i_main mt20">
       <div class="wp">
            ...
            <form method="post" action="index.php?m=Home&c=List&a=message" style="display: none;" id="wtfk">
                <div class="qusForm">
                    <h4 class="i_tit tc">フィードバック</h4>
                <div class="feedback">
                    <input type="hidden" name="typeid" value="2">
                    <input type="hidden" name="cjwt" value="フィードバック" class="wtfk">
                    <div class="item" id="wordCount">
                        <textarea name="message" required="" oninvalid="setCustomValidity('フィードバック/協業ご要望を入力してください')" oninput="setCustomValidity('')" id="" placeholder="フィードバック/協業ご要望を入力してください " class="textarea rd10"></textarea>
                        <span class="lastNum"><span class="word">1000</span>/1000</span>
                    </div>
                    <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('名前を入力してください')" oninput="setCustomValidity('')" name="name" placeholder="名前を入力してください" class="text rd10">
                        </div>
                        <div class="item">
                            <input type="number" required="" oninvalid="setCustomValidity('連絡先情報を入力してください')" oninput="setCustomValidity('')" placeholder="お問い合わせ" id="tel" name="tel" class="text rd10">
                            <!-- 默认不显示提示 -->
                            <div class="msg"></div>
                        </div>
                        <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('メールを入力してください')" oninput="setCustomValidity('')" name="email" id="email" placeholder="メールアドレス" class="text rd10">
                            <div class="msg"></div>
                        </div>
                    <div class="item tj tc">
                        <input type="submit" value="提出する" class="sbtn btn rd40 sbtn_green btn_tj">
                    </div>
                </div>
                <script>
                        // 问题反馈
            ...
            <form method="post" action="index.php?m=Home&c=List&a=message" style="display: block;" id="yjfk">
                <div class="qusForm">
                    <h4 class="i_tit tc">フィードバック</h4>
                <div class="feedback">
                    <input type="hidden" name="cjwt" value="フィードバック">
                    <input type="hidden" name="typeid" value="2">
                    <div class="item" id="wordCount">
                        <textarea name="message" required="" oninvalid="setCustomValidity('フィードバック/協業ご要望を入力してください')" oninput="setCustomValidity('')" id="" placeholder="フィードバック/協業ご要望を入力してください" class="textarea rd10"></textarea>
                        <span class="lastNum"><span class="word">1000</span>/1000</span>
                    ...
                    <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('名前を入力してください')" oninput="setCustomValidity('')" name="name1" placeholder="お名前" class="text rd10">
                        </div>
                        <div class="item">
                            <input type="number" required="" oninvalid="setCustomValidity('連絡先情報を入力してください')" oninput="setCustomValidity('')" placeholder="お問い合わせ" id="tel1" name="tel" class="text rd10">
                            <!-- 默认不显示提示 -->
                            <div class="msg"></div>
                        </div>
                        <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('メールを入力してください')" oninput="setCustomValidity('')" name="email" id="email1" placeholder="メールアドレス" class="text rd10">
                            <div class="msg"></div>
                        </div>
                    <div class="item tj tc">
                        <input type="submit" value="提出する" class="sbtn btn btn_bb rd40 sbtn_green">
                    </div>
                </div>
                <script>
                        // 问题反馈
    ...
    <script type="text/javascript">
           $('.btn_bb').click(function(){
                ...
                var dh=/^[0-9][0-9][0-9]{11}$/;
                    ...
                    if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                            $('#yjfk #tel1').focus();
                            $('#yjfk #tel1').next('.msg').html('あなたの携帯電話番号の形式が間違っている！');
                            return false;
                          }else{
                        ...
                        {
                           $('#yjfk #email1').next('.msg').html('不正な形式！再入力してください');
                           $("#yjfk #email1").focus();
                            return false;
                        }else{
     ...
     <script type="text/javascript">
           $('.btn_tj').click(function(){
                ...
                if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                            $('#wtfk #tel').focus();
                            $('#wtfk #tel').next('.msg').html('あなたの携帯電話番号の形式が間違っている！');
                            return false;
                          }else{
                        ...
                        if(!email.match(/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/))
                        {
                           $('#wtfk #email').next('.msg').html('不正な形式！再入力してください');
                           $("#wtfk #email").focus();
                            return false;
                        }else{
    ...
    $(document).ready(function() {
     ...
     <div class="footer" id="xz">
          <div class="f_t">
               <div class="wp">
                    <div class="fdown cle">
                         <h4 class="tit">ボタンをクリックしてMrメニューアプリケーションをダウンロードします</h4>
                         <div class="nr">
                              <?php $_result=get_news(23,32,0,0,'*',3);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a download="<?php echo ($v["file1"]); ?>" href="<?php echo ($v["file1"]); ?>"><img src="<?php echo ($v["img1"]); ?>" alt="" class="tp rd6">
                                   <div class="hdownLay">
                                        ...
                                        <h4 class="tit2">QRコードをスキャンして試します</h4>
                                   </div>
                    ...
                    <div class="fnav">
                         <ul class="fnavul cle">
                              ...
                              <li>
                                   ...
                                   <div class="nr1">
                                        <p class="p1">ジョイン：<?php echo sys('sys_gz');?></p>
                                        <p class="p1">募集：<?php echo sys('sys_zp');?></p>
                                   </div>
                              </li>
                         </ul>
                    </div>
          ...
          <div class="f_b">
               <div class="copyright tc"><?php echo sys('sys_copyright');?>
                    ...
                    <a href="http://www.9-xin.com" style="margin-left:5px;color:#fff" target="_blank">テクニカルサポート：Jiuxinネットワーク</a>
               </div>
          </div>
     </div>
     <!--底部-->
          <div class="floatpart">
               <ul class="floatpartul">
                    ...
                    <li ><a href="javascript:;" class="messbtn"><img src="./images/icon/side02.png" alt="" class="tp"></a>
                         <div class="messlay">
                                   <form class="hmform" method="post" action="index.php?m=Home&c=List&a=message"><h4 class="tit">お問い合わせ
                                          </h4>
                                        <input type="hidden" name="typeid" value="5">
                                        <div class="item">
                                             <div class="attrmc">お名前
                                                            <i class="require">*</i></div>
                                             <div class="attrval"><input placeholder="お名前
" required oninvalid="setCustomValidity('正しい連絡先を入力してください')" oninput="setCustomValidity('')" type="text" name="username" id="username" class="text rd10">
                                                  <!-- <div class="msg"></div> -->
                                             </div>
                                        </div>
                                        <div class="item">
                                             <div class="attrmc">お問い合わせ
                                                            <i class="require">*</i></div>
                                             <div class="attrval"><input placeholder="お問い合わせ
" required oninvalid="setCustomValidity('連絡先情報を入力してください')" oninput="setCustomValidity('')" type="number" name="tel" id="tel" class="text rd10">
                                                  <div class="msg"></div>
                                             </div>
                                        </div>
                                        <div class="item">
                                             ...
                                             <div class="attrval">
                                                  <select name="guojia" id="guojia" class="selCountry rd10" >
                                                       ...
                                                       <option value="イギリス">イギリス
                                                                   </option>
                                                       <option value="ドイツ">ドイツ
                                                                   </option>
                                                       <option value="日本">日本
                                                                   </option>
                                                       <option value="ユーロッパ">ユーロッパ</option>
                                                  </select>
                                             </div>
                                        </div>
                                        <div class="item">
                                             <div class="attrmc">レストラン名
                                                            <i class="require">*</i></div>
                                             <div class="attrval"><input placeholder="レストラン名
" required oninvalid="setCustomValidity('レストラン名を入力してください')" oninput="setCustomValidity('')" type="text" name="name" id="name" class="text rd10">
                                                  <!-- <div class="msg">Please enter the correct surname restaurant name</div> -->
                                             </div>
                                        </div>
                                        <div class="item">
                                             <div class="attrmc">レストランの住所
                                                            <i class="require">*</i></div>
                                             <div class="attrval">
                                                  <textarea  class="textarea" name="add" required oninvalid="setCustomValidity('レストランアドレスを入力してください')" oninput="setCustomValidity('')" placeholder="レストランの住所
" id="add" cols="30" rows="10"></textarea>
                                                  <!-- <div class="msg">Please enter the correct Restaurant Address</div> -->
                                             </div>
                                        </div>
                                        <div class="item tj tc"><input class="sbtn rd40 btn sbtn_green hmformBtn" type="submit" value="提出する
" /></div>
                                   </form>
                                   <script type="text/javascript">
                                        $('.hmformBtn').click(function(){
                                             ...
                                             if(tel.val() && username){
                                                  if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                                                    $('.hmform #tel').focus();
                                                    $('.hmform #tel').next('.msg').html('あなたの携帯電話番号の形式が間違っている！');
                                                    return false;
                                                  }else{
