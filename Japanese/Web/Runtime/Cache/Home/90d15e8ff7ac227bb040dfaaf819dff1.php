   ...
   <div class="imain2 bcover" style="background-image: url(./images/cooG_bg.png);">
        ...
        <div class="wrap">
                <div class="wrap2">
                        <div class="cooGrasp">
                             <div class="i_tit3 tc">
                                 <h4 class="tit">ミスターメニューコーポレーション</h4>
                                 <p class="tip">
                                     下記のフォームに記入し、リクエストを受け取るとすぐに返信いたします
                                 </p>
                             </div>
                             ...
                             <div class="form">
                                 ...
                                 <div class="field1">
                                    <div class="item">
                                        <div class="attrmc">レストラン名<i class="require">*</i></div>
                                        <div class="attrval">
                                            <input type="text" name="name" id="name" required oninvalid="setCustomValidity('レストラン名を入力してください')" oninput="setCustomValidity('')"  class="text rd10">
                                            <!-- <div class="msg" style="display:none;">Please enter the correct restaurant name</div> -->
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">レストランライプ<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="type" id="type" oninvalid="setCustomValidity('レストランタイップ')" oninput="setCustomValidity('')"   required  class="text rd10">
                                            <!-- <div class="msg">Please enter the correct restaurant type</div> -->
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">レストランの住所<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="add" id="add" oninvalid="setCustomValidity('レストランアドレスを入力してください')" oninput="setCustomValidity('')"   required  class="text rd10">
                                 ...
                                 <div class="field2">
                                    <div class="item">
                                        <div class="attrmc">メールアドレス<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="email" id="email" oninvalid="setCustomValidity('連絡先メールを入力してください')" oninput="setCustomValidity('')"  required class="text rd10">
                                            <div class="msg"></div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">お電話番号<i class="require">*</i></div>
                                        <div class="attrval"><input type="number" name="tel" id="tel" oninvalid="setCustomValidity('電話番号を入力してください')" oninput="setCustomValidity('')"  required class="text rd10">
                                            <div class="msg"></div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">お名前<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="username" required  id="" oninvalid="setCustomValidity('連絡先名を入力してください')" oninput="setCustomValidity('')"  class="text rd10">
                                            <!-- <div class="msg">Please enter the correct contact</div> -->
                                        </div>
                                    </div>
                                </div>
                                 <div class="item tj tc">
                                     <input type="submit" value="提出する" class="rd10 sbtn sbtn_green btn rd40">
                                   ...
                                   $('.btn').click(function(){
                                        ...
                                        var dh=/^[0-9][0-9][0-9]{11}$/;
                                            if(email){
                                                ...
                                                {
                                                   $('.form #email').next('.msg').html('不正な形式！再入力してください');
                                                   $(".form #email").focus();
                                                    return false;
                                                }else{
                                                ...
                                                if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                                                    $('.form #tel').focus();
                                                    $('.form #tel').next('.msg').html('あなたの携帯電話番号の形式が間違っている！');
                                                    return false;
                                                  }else{
