...
<body>
                                        ...
                                        <li><a href="javascript:;" <?php echo $vpid==18 ? 'class="act_nav"':''; echo $vpid==35 ? 'class="act_nav"':''; ?>>私たちについて<i class="iconfont icon-down2"></i></a>
                                             <div class="subnav zj">
                                                  <div class="nr">
                                                    ...
                                                    <a href="index.php?m=&c=List&a=message&pid=18&ty=22&tty=0" >協業についてN</a>
                                                  </div>
                                             </div>
                                        </li>
                                   </ul>
                              ...
                              <div class="inav">
                                   <div class="wrap">
                                        ...
                                        <dl>
                                             ...
                                             <h6><a href="index.php?m=&c=List&a=message&pid=18&ty=22&tty=0" >協業についてN</a></h6>
                                             </dd>
                                        </dl>
                                   </div>
                              </div>
    ...
    <div class="i_main mt20">
        <div class="wp">
            <div class="solu mt60">
                <div class="lm">
                    <?php $_result=get_sort_list($vpid);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($vty == $v["id"]): ?><a class="act_lm" href="<?php echo get_sort_url($v['pid'],$v['id'],0,$v['linkurl']);?>"><?php echo ($v["catname"]); ?></a>
                            <?php else: ?>
                                <a href="<?php echo get_sort_url($v['pid'],$v['id'],0,$v['linkurl']);?>"><?php echo ($v["catname"]); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                    <!-- <a href="" class="act_lm">点餐小程序</a> -->
                    <!-- <a href="">Mr.Menu APP</a> -->
                </div>
                <?php if($vty == 5): ?><div class="soluArea mt20">
                        <ul class="sa_tit sa_tit2">
                            <?php $j=0;?>
                            <?php $_result=get_news($vpid,$vty,0,0,'*',5);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($i == 3): $i++; endif; ?>
                                <?php $j++;?>
                                <?php if($i == 1): ?><li class="li0<?php echo $i;?> act_sa">
                                        <div class="box rd10">
                                            <div class="nr">
                                                <h4 class="tit"><?php echo ($v["title"]); ?></h4>
                                                <div class="des"><?php echo get_nl2br($v['introduce']);?></div>
                                            </div>
                                            <span class="rdhalf num">0<?php echo $j;?></span>
                                        </div>
                                    </li>
                                    <?php else: ?>
                                    <li class="li0<?php echo $i;?>">
                                        <div class="box rd10">
                                            <div class="nr">
                                                <h4 class="tit"><?php echo ($v["title"]); ?></h4>
                                                <div class="des"><?php echo get_nl2br($v['introduce']);?></div>
                        ...
                        <div class="sa_con">
                            <?php $_result=get_news($vpid,$vty,0,0,'*',5);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><img src="./images/solu_bg.png" alt="" class="phoneRim">
                                <?php if($i == 1): ?><div class="sabox" style="display: block;"><img src="<?php echo ($v["img1"]); ?>" alt="" class="tp"></div>
                                <?php else: ?>
                                    <div class="sabox"><img src="<?php echo ($v["img1"]); ?>" alt="" class="tp"></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                            
                        </div>
                    </div>
                    <div class="sDown2 tc mt40">
                        <img src="<?php echo sys('sys_img6');?>" alt="" class="tp">
                        <p class="tit">Scan QR code to experience
                        </p>
                    </div>
                <?php else: ?>
                    <div class="soluArea mt20">
                        <ul class="sa_tit sa_tit1">
                            <?php $_result=get_news($vpid,$vty,0,0,'*',6);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($i == 1): ?><li class="li0<?php echo $i;?> act_sa">
                                        <div class="box rd10">
                                            <div class="nr"><?php echo get_nl2br($v['introduce']);?></div>
                                            <span class="rdhalf num">0<?php echo $i;?></span>
                                        </div>
                                    </li>
                                <?php else: ?>
                                    <li class="li0<?php echo $i;?>">
                        ...
                        <div class="sa_con">
                            <?php $_result=get_news($vpid,$vty,0,0,'*',6);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><img src="./images/solu_bg.png" alt="" class="phoneRim">
                                <?php if($i == 1): ?><div class="sabox" style="display: block;"><img src="<?php echo ($v["img1"]); ?>" alt="" class="tp"></div>
                                <?php else: ?>
                                    <div class="sabox"><img src="<?php echo ($v["img1"]); ?>" alt="" class="tp"></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                    <div class="sDown tc mt40">
                        <?php $_result=get_news(23,32,0,0,'*',3);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($i == 1): ?><a href="<?php echo ($v["file1"]); ?>" download="<?php echo ($v["file1"]); ?>" class="rd10 btn">
                                    ...
                                    <div class="downLay">
                                            ...
                                            <p class="tit">Scan QR code</p>
                                        </div>
                                </a>
                                <elseif condition='$i eq 2'>
                                    <a href="<?php echo ($v["file1"]); ?>" download="<?php echo ($v["file1"]); ?>" class="rd10 btn">
                    ...
                    <div class="fnav">
                         <ul class="fnavul cle">
                              ...
                              <li>
                                   ...
                                   <div class="nr1">
                                        <p class="p1">協力する：<?php echo sys('sys_gz');?></p>
          ...
          <div class="floatpart">
               <ul class="floatpartul">
                    ...
                    <li ><a href="javascript:;" class="messbtn"><img src="./images/icon/side02.png" alt="" class="tp"></a>
                         <div class="messlay">
                                   <form class="hmform" method="post" action="index.php?m=Home&c=List&a=message"><h4 class="tit">理解と協力
                                          </h4>
