              ...
              <header class="header iheader"><?php endif; ?>
                  <div class="loarea">
                         <div class="wp clearfix">
                              <a class="logo"><img src="images/icon/logo.png" /></a>
                              <!--PC nav -->
                              <nav class="nav">
                                   <ul class="wp navul">
                                        <li><a <?php echo empty($vpid) ? 'class="act_nav"':''; ?> href="/en/">home</a></li>
                                        <li><a href="javascript:;" <?php echo $vpid==1 ? 'class="act_nav"':''; ?> ><?php echo get_sort_zd(3);?>
                                          <i class="iconfont icon-down2"></i></a>
                                             <div class="subnav">
                                                  <div class="nr">
                                        ...
                                        <li><a href="javascript:;">ABOUT US<i class="iconfont icon-down2"></i></a>
                                             <div class="subnav zj">
                                                  <div class="nr">
                                                    <a href="index.php?m=&c=List&a=About&pid=35&ty=37&tty=0" >ABOUT US</a>
                                                    <a href="index.php?m=&c=List&a=common&pid=18&ty=21&tty=0" >COMMON PROBLEM</a>
                              ...
                              <div class="inav">
                                   ...
                                   <dl>
                                        ...
                                        <dd>
                                            <?php $_result=get_sort_list(43);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><h6><a href="<?php echo get_sort_url($v['pid'],$v['id'],0,$v['linkurl']);?>"><?php echo ($v["catname"]); ?></a></h6><?php endforeach; endif; else: echo "" ;endif; ?>
                                           ...
                                           <h6><a href="index.php?m=&c=List&a=message&pid=18&ty=22&tty=0" ><?php echo get_sort_zd(22);?></a></h6>
                                        </dd>
                                   </dl>
                              </div>
                              <!--手机导航end-->
    ...
    $(document).ready(function() {
     ...
     <div class="footer" id="xz">
          <div class="f_t">
               <div class="wp">
                    <div class="fdown cle">
                         <h4 class="tit">Click the right side to download the Mr. menu application</h4>
                         <div class="nr">
                              <?php $_result=get_news(23,32,0,0,'*',3);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="<?php echo ($v["file1"]); ?>"><img src="<?php echo ($v["img1"]); ?>" alt="" class="tp rd6">
                                   <div class="hdownLay">
                    ...
                    <div class="fnav">
                         <ul class="fnavul cle">
                              ...
                              <li>
                                   <h4 class="ftit">Customer support</h4>
                                   <div class="nr2">
