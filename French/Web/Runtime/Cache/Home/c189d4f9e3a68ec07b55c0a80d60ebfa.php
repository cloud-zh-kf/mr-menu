    ...
    <div class="i_main mt20">
       <div class="wp">
            ...
            <form method="post" action="index.php?m=Home&c=List&a=message" style="display: none;" id="wtfk">
                <div class="qusForm">
                    <h4 class="i_tit tc">Rétroaction de problème</h4>
                <div class="feedback">
                    <input type="hidden" name="typeid" value="2">
                    <input type="hidden" name="cjwt" value="Rétroaction de problème" class="wtfk">
                    <div class="item" id="wordCount">
                        <textarea name="message" required="" oninvalid="setCustomValidity('S’il vous plaît entrer votre commentaire / intention de coopération')" oninput="setCustomValidity('')" id="" placeholder="S’il vous plaît entrer votre commentaire / intention de coopération" class="textarea rd10"></textarea>
                        <span class="lastNum"><span class="word">1000</span>/1000</span>
                    </div>
                    <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('S’il vous plaît entrer un nom')" oninput="setCustomValidity('')" name="name" placeholder="Nom" class="text rd10">
                        </div>
                        <div class="item">
                            <input type="number" required="" oninvalid="setCustomValidity('Veuillez entrer les coordonnées')" oninput="setCustomValidity('')" placeholder="Coordonnées" id="tel" name="tel" class="text rd10">
                            <!-- 默认不显示提示 -->
                            <div class="msg"></div>
                        </div>
                        <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('S’il vous plaît entrer e-mail')" oninput="setCustomValidity('')" name="email" id="email" placeholder="Mailbox" class="text rd10">
                            <div class="msg"></div>
                        </div>
                    <div class="item tj tc">
                        <input type="submit" value="Présenté" class="sbtn btn rd40 sbtn_green btn_tj">
                    </div>
                </div>
                <script>
                        // 问题反馈
            ...
            <form method="post" action="index.php?m=Home&c=List&a=message" style="display: block;" id="yjfk">
                <div class="qusForm">
                    <h4 class="i_tit tc">Commentaires</h4>
                <div class="feedback">
                    <input type="hidden" name="cjwt" value="Commentaires">
                    <input type="hidden" name="typeid" value="2">
                    <div class="item" id="wordCount">
                        <textarea name="message" required="" oninvalid="setCustomValidity('S’il vous plaît entrer votre commentaire / intention de coopération')" oninput="setCustomValidity('')" id="" placeholder="S’il vous plaît entrer votre commentaire / intention de coopération " class="textarea rd10"></textarea>
                        <span class="lastNum"><span class="word">1000</span>/1000</span>
                    ...
                    <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('S’il vous plaît entrer un nom')" oninput="setCustomValidity('')" name="name1" placeholder="Nom" class="text rd10">
                        </div>
                        <div class="item">
                            <input type="number" required="" oninvalid="setCustomValidity('Veuillez entrer les coordonnées')" oninput="setCustomValidity('')" placeholder="Coordonnées" id="tel1" name="tel" class="text rd10">
                            <!-- 默认不显示提示 -->
                            <div class="msg"></div>
                        </div>
                        <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('S’il vous plaît entrer e-mail')" oninput="setCustomValidity('')" name="email" id="email1" placeholder="Boîte aux lettres" class="text rd10">
                            <div class="msg"></div>
                        </div>
                    <div class="item tj tc">
                        <input type="submit" value="Présenté" class="sbtn btn btn_bb rd40 sbtn_green">
                    </div>
                </div>
                <script>
                        // 问题反馈
    ...
    <script type="text/javascript">
           $('.btn_bb').click(function(){
                ...
                var dh=/^[0-9][0-9][0-9]{11}$/;
                    ...
                    if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                            $('#yjfk #tel1').focus();
                            $('#yjfk #tel1').next('.msg').html('Le format de votre numéro de téléphone mobile est incorrect!');
                            return false;
                          }else{
                        ...
                        {
                           $('#yjfk #email1').next('.msg').html('Format incorrect! S’il vous plaît re-entrer');
                           $("#yjfk #email1").focus();
                            return false;
                        }else{
     ...
     <script type="text/javascript">
           $('.btn_tj').click(function(){
                ...
                if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                            $('#wtfk #tel').focus();
                            $('#wtfk #tel').next('.msg').html('Le format de votre numéro de téléphone mobile est incorrect!');
                            return false;
                          }else{
                        ...
                        if(!email.match(/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/))
                        {
                           $('#wtfk #email').next('.msg').html('Format incorrect! S’il vous plaît re-entrer');
                           $("#wtfk #email").focus();
                            return false;
                        }else{
