...
<body>
    ...
    <div class="i_main">
       <div class="wp">
            <div class="location">
                <a href="javascript:;" onClick="window.history.go(-1)" ><?php echo get_sort_zd($vty);?></a><i class="cutline">/</i><a class="act_loca" href="">Details of Article
            </a>
            </div>
            <div class="newDel">
                <?php $_result=get_view($id);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="n_tit">
                        <h4 class="tit"><?php echo ($v["title"]); ?></h4>
                        <div class="time"><?php echo get_time($v['sendtime']);?></div>
                    </div>
                    <div class="n_del">
