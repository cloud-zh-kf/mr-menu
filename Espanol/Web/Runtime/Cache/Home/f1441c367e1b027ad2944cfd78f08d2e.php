...
<body>
    ...
    <div class="i_main mt20">
       <div class="wp">
            <h4 class="i_tit tc"><?php echo get_sort_zd(29);?></h4>
            <div class="favCase">
               ...
               <!-- turnpage -->
                <div class="turnpage">
                    ...
                    <?php echo get_news_fym(6,23,29);?>

                    <em class="go">To page<input type="text" name="page" value="<?php echo $_GET['p'] ? $_GET['p']:1;?>" class="num"></em>
                    <input type="submit" class="tj fytj" value="Sí">
                </div>
            </div>
       </div>
    </div>
    <script type="text/javascript">
        $('.fytj').click(function(){
            ...
            window.location.href='List-favorabl.html?Home-List-favorabl_html=&pid='+<?php echo $vpid;?>+'&ty='+<?php echo $vty;?>+'&tty='+<?php echo $vtty;?>+'&Home-List-favorabl-pid-'+<?php echo $vpid;?>+'-ty-'+<?php echo $vty;?>+'-tty-'+<?php echo $vtty;?>+'_html=&p='+page;
