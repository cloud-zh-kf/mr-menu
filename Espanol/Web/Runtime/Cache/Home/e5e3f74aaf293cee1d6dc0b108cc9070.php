...
<body>
    ...
    <!--main-->
    <div class="h_pos mt20">
          <div class="wp">
                    <h4 class="i_tit tc"><?php echo get_sort_zd(45);?></h4>
               <div class="wrap">
                    <ul class="hposul cle">
                         <?php $_result=get_news(45,46,0,0,'*',10000);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($v["linkurl"]); ?>" target="_blank"><img src="<?php echo ($v["img1"]); ?>" alt=""  class="tp"></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
               </div>
          </div>
     </div>
