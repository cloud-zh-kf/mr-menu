...
<body>
    ...
    <div class="i_main wp">
         <div class="features">
             <div class="fItem mobileF">
                 <h4 class="fea_tit tc"><?php echo get_sort_zd(38);?></h4>
                 <ul class="mobileFul cle">
                    <?php $_result=get_news(1,38,0,0,'*');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
             ...
             <div class="fItem">
                <?php $_result=get_news(1,34,0,0,'*',1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><h4 class="fea_tit tc"><?php echo ($v["title"]); ?></h4>
