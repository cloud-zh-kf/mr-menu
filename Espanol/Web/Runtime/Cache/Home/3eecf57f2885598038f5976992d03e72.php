...
<body>
    ...
    <div class="i_main mt20">
       <div class="wp">
            ...
            <div class="news mt20">
                <ul class="newsul cle">
                    <?php $_result=get_news($vpid,$vty,0,0,'*',6);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                            <a href="<?php echo get_url($v['id']);?>">
                                <span class="tparea"><img alt="" class="tp" src="<?php echo ($v["img1"]); ?>"></span>
                                <div class="des">
                                    <h4 class="tit"><?php echo ($v["title"]); ?></h4>
                                    <div class="time"><?php echo get_time($v['sendtime'],'Y-m-d');?></div>
                                    <p class="nr"><?php echo cutstr_html($v['content'],200);?></p>
                                </div>
                            </a>
                ...
                <div class="turnpage">
                    ...
                    <input type="submit" class="tj fytj" value="OK
">
                </div>
