...
<body>
    ...
    <div class="i_main wp">
         <div class="features">
             <div class="fItem websiteF">
                 <h4 class="fea_tit tc"><?php echo get_sort_zd(36);?></h4>
                 <ul class="websiteFul cle">
                    <?php $_result=get_news(35,36,0,0,'*');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                         <a href="<?php echo ($v["linkurl"]); ?>">
                             ...
                             <div class="mandiv tc">
                                 <span class="sbtn sbtn_green rd40">Haga clic para probar</span>
                             </div>
                         </a>
             ...
             <div class="fItem">
                <?php $_result=get_news(35,37,0,0,'*',1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><h4 class="fea_tit tc"><?php echo ($v["title"]); ?></h4>
