...
<body>
    ...
    <div class="i_main">
       <div class="wp">
           <div class="imainWrap rd10">
               <div class="policy">
                   <h4 class="i_tit2 tc b"><?php echo get_sort_zd($vty);?></h4>
                   <div class="nr">
                        <?php $_result=get_news($vpid,$vty,0,0,'*',6);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; echo get_html($v['content']); endforeach; endif; else: echo "" ;endif; ?>
                   </div>
               </div>
           </div>
       </div>
