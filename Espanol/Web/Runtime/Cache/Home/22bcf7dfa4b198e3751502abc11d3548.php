...
<body>
    ...
    <!--main-->
    <div class="i_main">
        <?php $_result=get_news(43,44,0,0,'*',1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="vision bcover" style="background-image: url(./images/vision_bg.jpg);">
             <div class="wp">
