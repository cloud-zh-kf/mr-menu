              ...
              <header  id="mainMenuBar" class="header iheader"><?php endif; ?>
                  <div class="loarea">
                         <div class="wp clearfix">
                              <a class="logo" href="/Espanol/"><img src="<?php echo sys('sys_img1');?>" /></a>
                              <!--PC nav -->
                              <nav class="nav">
                                   <ul class="wp navul">
                                        <li><a <?php echo empty($vpid) ? 'class="act_nav"':''; ?> href="/Espanol/">Inicio</a></li>
                                        ...
                                        <li><a href="javascript:;" <?php echo $vpid==18 ? 'class="act_nav"':''; echo $vpid==35 ? 'class="act_nav"':''; ?>>Sobre Nosotros<i class="iconfont icon-down2"></i></a>
                                             <div class="subnav zj">
                                                  <div class="nr">
                                                    <a href="index.php?m=&c=List&a=About&pid=35&ty=37&tty=0" >Nuestra Visión</a>
                                                    <a href="index.php?m=&c=List&a=common&pid=18&ty=21&tty=0" ><?php echo get_sort_zd(21);?></a>
                                                    <a href="index.php?m=&c=List&a=message&pid=18&ty=22&tty=0" >sobre la cooperación </a>
                                                  </div>
                                             </div>
                                        </li>
                                   </ul>
                              ...
                              <div class="chooseLan rd30">
                                   <div class="curLan">
                                        ...
                                        <span class="val ibvm">Español</span></div>
                                   <div class="lanLay">
                                        <ul class="lanul cle">
                              ...
                              <div class="inav">
                                   <div class="wrap">
                                        ...
                                        <dl>
                                             ...
                                             <dd>
                                             <h6><a href="index.php?m=&c=List&a=About&pid=35&ty=37&tty=0" >Nuestra Visión</a></h6>
                                             <h6><a href="index.php?m=&c=List&a=common&pid=18&ty=21&tty=0" ><?php echo get_sort_zd(21);?></a></h6>
                                             <h6><a href="index.php?m=&c=List&a=message&pid=18&ty=22&tty=0" >sobre la cooperación </a></h6>
                                             </dd>
                                        </dl>
                                   </div>
                              </div>
                                        ...
                                        <div class="mandiv">
                                          <!-- popupVideo1 -->
                                             <a href="<?php echo get_url($v['id'],'List','video');?>" class=" sbtn_ban btn rd40">
                                                  <span class="val">Saber más sobre el Mr. Menu</span>
   ...
   <div class="imain2 bcover" style="background-image: url(./images/cooG_bg.png);">
        ...
        <div class="wrap">
                <div class="wrap2">
                        <div class="cooGrasp">
                             <div class="i_tit3 tc">
                                 <h4 class="tit">Mr.Menu Cooperación</h4>
                                 <p class="tip">
                                     Por favor rellene el formulario que figura a continuación, y responderemos tan pronto como recibamos su solicitud.
                                 </p>
                             </div>
                            
                             <form method="post" action="index.php?m=Home&c=List&a=message" >
                             <div class="form">
                                
                                 <div class="item">
                                     <div class="attrmc">¿Qué es lo que necesitas?<i class="require">*</i></div>
                                     <div class="attrval">
                                         <div class="seltype" id="seltype">
                                             <div class="list"><input type="radio" value="3" name="typeid" class="radio" id="">
                                                <span class="ibvm">Cooperación restaurante</span>
                                             </div>
                                             <div class="list"><input type="radio" value="4" name="typeid" class="radio" id="">
                                                <span class="ibvm">Otros</span>
                                             </div>
                                         </div>
                                     </div>
                                 </div>
                                 <div class="field1">
                                    <div class="item">
                                        <div class="attrmc">Nombre del restaurante<i class="require">*</i></div>
                                        <div class="attrval">
                                            <input type="text" name="name" id="name" required oninvalid="setCustomValidity('Escriba el nombre del restaurante.')" oninput="setCustomValidity('')"  class="text rd10">
                                            <!-- <div class="msg" style="display:none;">Please enter the correct restaurant name</div> -->
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Tipo de restaurante<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="type" id="type" oninvalid="setCustomValidity('Tipo de restaurante')" oninput="setCustomValidity('')"   required  class="text rd10">
                                            <!-- <div class="msg">Please enter the correct restaurant type</div> -->
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Dirección del restaurante<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="add" id="add" oninvalid="setCustomValidity('Introduzca la dirección del restaurante.')" oninput="setCustomValidity('')"   required  class="text rd10">
                                            <!-- <div class="msg">Please enter the correct contact address</div> -->
                                        </div>
                                    </div>
                                 </div>
                                 <div class="field2">
                                    <div class="item">
                                        <div class="attrmc">dirección<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="email" id="email" oninvalid="setCustomValidity('Por favor, introduzca su dirección de correo electrónico')" oninput="setCustomValidity('')"  required class="text rd10">
                                            <div class="msg"></div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Tel.<i class="require">*</i></div>
                                        <div class="attrval"><input type="number" name="tel" id="tel" oninvalid="setCustomValidity('Por favor, introduzca el teléfono')" oninput="setCustomValidity('')"  required class="text rd10">
                                            <div class="msg"></div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Los nombres<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="username" required  id="" oninvalid="setCustomValidity('Por favor, introduzca el nombre de la persona de contacto')" oninput="setCustomValidity('')"  class="text rd10">
                                            <!-- <div class="msg">Please enter the correct contact</div> -->
                                        </div>
                                    </div>
                                </div>
                                 <div class="item tj tc">
                                     <input type="submit" value="presentación" class="rd10 sbtn sbtn_green btn rd40">
                                   ...
                                   $('.btn').click(function(){
                                        ...
                                        var dh=/^[0-9][0-9][0-9]{11}$/;
                                            if(email){
                                                ...
                                                {
                                                   $('.form #email').next('.msg').html('¡El formato no es correcto! Por favor, vuelva a introducir');
                                                   $(".form #email").focus();
                                                    return false;
                                                }else{
                                                   $('.form #email').next('.msg').html('');
                                                }

                                                if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                                                    $('.form #tel').focus();
                                                    $('.form #tel').next('.msg').html('Su número de teléfono celular no está en el formato correcto');
                                                    return false;
                                                  }else{
                                                    $('.form #tel').next('.msg').html('');
                                                  }
                                            }
                                    });
                             </script>
                        ...
                        <script>
                            $(function(){
                                $('#seltype input[type=radio][name=typeid]').change(function() {
                                        if (this.value == '3') {
                                           $('.field1,.field2').slideDown();
                                           $(':input[name="name"]').attr('required','required');
                                           $(':input[name="type"]').attr('required','required');
                                           $(':input[name="add"]').attr('required','required');
                                        }
                                            ...
                                            $(':input[name="add"]').removeAttr('required');
                                        }
                                    });
                                })
                        </script>
    ...
    $(document).ready(function() {
     ...
     <div class="footer" id="xz">
          <div class="f_t">
               <div class="wp">
                    <div class="fdown cle">
                         <h4 class="tit">Haga clic a la derecha para descargar la aplicación Mr. Menu</h4>
                         <div class="nr">
                              <?php $_result=get_news(23,32,0,0,'*',3);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a download="<?php echo ($v["file1"]); ?>" href="<?php echo ($v["file1"]); ?>"><img src="<?php echo ($v["img1"]); ?>" alt="" class="tp rd6">
                                   <div class="hdownLay">
                                        ...
                                        <h4 class="tit2">Escanear código QR para probar</h4>
                                   </div>
                    ...
                    <div class="fnav">
                         <ul class="fnavul cle">
                              ...
                              <li>
                                   <h4 class="ftit b">Atención al cliente</h4>
                                   <div class="nr2">
                              ...
                              <li>
                                   ...
                                   <div class="nr1">
                                        <p class="p1">Cooperación:<?php echo sys('sys_gz');?></p>
                                        <p class="p1">Reclutamiento:<?php echo sys('sys_zp');?></p>
                                   </div>
                              </li>
                         </ul>
                    </div>
          ...
          <div class="f_b">
               <div class="copyright tc"><?php echo sys('sys_copyright');?>
                    ...
                    <a href="http://www.9-xin.com" style="margin-left:5px;color:#fff" target="_blank">Soporte técnico: Jiuxin network</a>
               </div>
          </div>
     </div>
     <!--底部-->
          <div class="floatpart">
               <ul class="floatpartul">
                    ...
                    <li ><a href="javascript:;" class="messbtn"><img src="./images/icon/side02.png" alt="" class="tp"></a>
                         <div class="messlay">
                                   <form class="hmform" method="post" action="index.php?m=Home&c=List&a=message"><h4 class="tit">Cooperación</h4>
                                        <input type="hidden" name="typeid" value="5">
                                        <div class="item">
                                             <div class="attrmc">Nombre
                                                            <i class="require">*</i></div>
                                             <div class="attrval"><input placeholder="Nombre" required oninvalid="setCustomValidity('Por favor introduzca el contacto correcto')" oninput="setCustomValidity('')" type="text" name="username" id="username" class="text rd10">
                                                  <!-- <div class="msg"></div> -->
                                             </div>
                                        </div>
                                        <div class="item">
                                             <div class="attrmc">Información del contacto
                                                            <i class="require">*</i></div>
                                             <div class="attrval"><input placeholder="Información del contacto" required oninvalid="setCustomValidity('Por favor ingrese la información de contacto correcta')" oninput="setCustomValidity('')" type="number" name="tel" id="tel" class="text rd10">
                                                  <div class="msg"></div>
                                             </div>
                                        </div>
                                        <div class="item">
                                             <div class="attrmc">País
                                                            <i class="require">*</i></div>
                                             <div class="attrval">
                                        ...
                                        <div class="item">
                                             <div class="attrmc">Nombre del restaurante
                                                            <i class="require">*</i></div>
                                             <div class="attrval"><input placeholder="Nombre del restaurante" required oninvalid="setCustomValidity('Por favor introduzca el nombre correcto del restaurante')" oninput="setCustomValidity('')" type="text" name="name" id="name" class="text rd10">
                                                  <!-- <div class="msg">Please enter the correct surname restaurant name</div> -->
                                             </div>
                                        </div>
                                        <div class="item">
                                             <div class="attrmc">Dirección del restaurante
                                                            <i class="require">*</i></div>
                                             <div class="attrval">
                                                  <textarea  class="textarea" name="add" required oninvalid="setCustomValidity('Por favor introduzca la dirección correcta del restaurante')" oninput="setCustomValidity('')" placeholder="Restaurant address
" id="add" cols="30" rows="10"></textarea>
                                                  <!-- <div class="msg">Please enter the correct Restaurant Address</div> -->
                                             </div>
                                        </div>
                                        <div class="item tj tc"><input class="sbtn rd40 btn sbtn_green hmformBtn" type="submit" value="Enviar" /></div>
                                   </form>
                                   <script type="text/javascript">
                                        $('.hmformBtn').click(function(){
                                             ...
                                             if(tel.val() && username){
                                                  if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                                                    $('.hmform #tel').focus();
                                                    $('.hmform #tel').next('.msg').html('Número de teléfono incorrecto！');
                                                    return false;
                                                  }else{
                                   ...
                                   <div class="subAchieve">
                                        <h4 class="tit">Cooperación
                                                </h4>
                                        <div class="nr">
                                             <div class="tp"><i class="iconfont icon-jinakangbaoicons17"></i></div>
                                             <p class="p1">Enviado con éxito
                                                            <br>Nos pondremos en contacto con usted lo antes posible
                                                            ～</p>
                                        </div>
                                        <div class="tj tc">
                                             <input class="sbtn rd40 btn sbtn_green subAchieveBtn" type="submit" value="Sí" />
                                        </div>
                                   </div>
                              </div>
                    </li>
                    <li class="codeBtn"><a href="javascript:;"><img src="./images/icon/side03.png" alt="" class="tp"></a>
                         <div class="codeLay">
                              ...
                              <p class="tit">Cuenta pública de Mr.Menu
                                    </p>
                         </div>
                    </li>
                    <li class="codeBtn"><a href="javascript:;"><img src="./images/icon/side04.png" alt="" class="tp"></a>
                         <div class="codeLay">
                                   ...
                                   <p class="tit">Sina Weibo de Mr.Menu
                                          </p>
                              </div>
                    </li>
