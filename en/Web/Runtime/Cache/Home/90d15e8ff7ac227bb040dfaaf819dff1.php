   ...
   <div class="imain2 bcover" style="background-image: url(./images/cooG_bg.png);">
        ...
        <div class="wrap">
                <div class="wrap2">
                        <div class="cooGrasp">
                             <div class="i_tit3 tc">
                                 <h4 class="tit">Mr.Menu cooperation                                 </h4>
                                 <p class="tip">
                             ...
                             <div class="form">
                                 ...
                                 <div class="field1">
                                    <div class="item">
                                        <div class="attrmc">Restaurant name<i class="require">*</i></div>
                                        <div class="attrval">
                                            <input type="text" name="name" id="name" required oninvalid="setCustomValidity('Please enter the restaurant name')" oninput="setCustomValidity('')"  class="text rd10">
                                            <!-- <div class="msg" style="display:none;">Please enter the correct restaurant name</div> -->
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Restaurant type<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="type" id="type" oninvalid="setCustomValidity('Please enter restaurant type')" oninput="setCustomValidity('')"   required  class="text rd10">
                                            <!-- <div class="msg">Please enter the correct restaurant type</div> -->
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Restaurant address<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="add" id="add" oninvalid="setCustomValidity('Please enter the restaurant address')" oninput="setCustomValidity('')"   required  class="text rd10">
                                 ...
                                 <div class="field2">
                                    <div class="item">
                                        <div class="attrmc">Mailbox<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="email" id="email" oninvalid="setCustomValidity('Please enter the contact email')" oninput="setCustomValidity('')"  required class="text rd10">
                                            <div class="msg"></div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Tel<i class="require">*</i></div>
                                        <div class="attrval"><input type="number" name="tel" id="tel" oninvalid="setCustomValidity('Please enter the phone number')" oninput="setCustomValidity('')"  required class="text rd10">
                                            <div class="msg"></div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Contact name<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="username" required  id="" oninvalid="setCustomValidity('Please enter contact name')" oninput="setCustomValidity('')"  class="text rd10">
                                            <!-- <div class="msg">Please enter the correct contact</div> -->
                                        </div>
                                    </div>
                                </div>
                                 <div class="item tj tc">
                                     <input type="submit" value="Submit" class="rd10 sbtn sbtn_green btn rd40">
                                   ...
                                   $('.btn').click(function(){
                                        ...
                                        var dh=/^[0-9][0-9][0-9]{11}$/;
                                            if(email){
                                                ...
                                                {
                                                   $('.form #email').next('.msg').html('Incorrect format! Please re-enter');
                                                   $(".form #email").focus();
                                                    return false;
                                                }else{
                                                ...
                                                if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                                                    $('.form #tel').focus();
                                                    $('.form #tel').next('.msg').html('The format of your mobile number is incorrect！');
                                                    return false;
                                                  }else{
