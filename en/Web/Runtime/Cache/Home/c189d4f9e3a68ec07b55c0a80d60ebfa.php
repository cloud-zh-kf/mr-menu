                         ...
                         <div class="wp clearfix">
                              ...
                              <nav class="nav">
                                   <ul class="wp navul">
                                        ...
                                        <li><a href="javascript:;" <?php echo $vpid==18 ? 'class="act_nav"':''; echo $vpid==35 ? 'class="act_nav"':''; ?>>ABOUT US<i class="iconfont icon-down2"></i></a>
                                             <div class="subnav zj">
                                                  <div class="nr">
    ...
    <div class="i_main mt20">
       <div class="wp">
            ...
            <form method="post" action="index.php?m=Home&c=List&a=message" style="display: none;" id="wtfk">
                <div class="qusForm">
                    <h4 class="i_tit tc">Problem feedback</h4>
                <div class="feedback">
                    <input type="hidden" name="typeid" value="2">
                    <input type="hidden" name="cjwt" value="Problem feedback" class="wtfk">
                    <div class="item" id="wordCount">
                        <textarea name="message" required="" oninvalid="setCustomValidity('Please enter your feedback / cooperation intention\n')" oninput="setCustomValidity('')" id="" placeholder="Please enter your feedback / cooperation intention " class="textarea rd10"></textarea>
                        <span class="lastNum"><span class="word">1000</span>/1000</span>
                    </div>
                    <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('Please enter a name')" oninput="setCustomValidity('')" name="name" placeholder="Name" class="text rd10">
                        </div>
                        <div class="item">
                            <input type="number" required="" oninvalid="setCustomValidity('Please enter contact information')" oninput="setCustomValidity('')" placeholder="Contact information" id="tel" name="tel" class="text rd10">
                            <!-- 默认不显示提示 -->
                            <div class="msg"></div>
                        </div>
                        <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('Please enter email')" oninput="setCustomValidity('')" name="email" id="email" placeholder="Mailbox" class="text rd10">
                            <div class="msg"></div>
                        </div>
                    <div class="item tj tc">
                        <input type="submit" value="Submit" class="sbtn btn rd40 sbtn_green btn_tj">
                    </div>
                </div>
                <script>
                        // 问题反馈
            ...
            <form method="post" action="index.php?m=Home&c=List&a=message" style="display: block;" id="yjfk">
                ...
                <div class="feedback">
                    ...
                    <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('Please enter a name')" oninput="setCustomValidity('')" name="name1" placeholder="Name" class="text rd10">
                        </div>
                        <div class="item">
                            <input type="number" required="" oninvalid="setCustomValidity('Please enter contact information')" oninput="setCustomValidity('')" placeholder="Contact information" id="tel1" name="tel" class="text rd10">
                            <!-- 默认不显示提示 -->
                            <div class="msg"></div>
                        </div>
                        <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('Please enter email')" oninput="setCustomValidity('')" name="email" id="email1" placeholder="Mailbox" class="text rd10">
                            <div class="msg"></div>
                        </div>
                    <div class="item tj tc">
                        <input type="submit" value="Submit" class="sbtn btn btn_bb rd40 sbtn_green">
                    </div>
                </div>
                <script>
                        // 问题反馈
    ...
    <script type="text/javascript">
           $('.btn_bb').click(function(){
                ...
                var dh=/^[0-9][0-9][0-9]{11}$/;
                    ...
                    if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                            $('#yjfk #tel1').focus();
                            $('#yjfk #tel1').next('.msg').html('The format of your mobile number is incorrect！');
                            return false;
                          }else{
                        ...
                        {
                           $('#yjfk #email1').next('.msg').html('Incorrect format! Please re-enter');
                           $("#yjfk #email1").focus();
                            return false;
                        }else{
     ...
     <script type="text/javascript">
           $('.btn_tj').click(function(){
                ...
                if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                            $('#wtfk #tel').focus();
                            $('#wtfk #tel').next('.msg').html('The format of your mobile number is incorrect！');
                            return false;
                          }else{
                        ...
                        if(!email.match(/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/))
                        {
                           $('#wtfk #email').next('.msg').html('Incorrect format! Please re-enter');
                           $("#wtfk #email").focus();
                            return false;
                        }else{
    ...
    $(document).ready(function() {
     ...
     <div class="footer" id="xz">
          <div class="f_t">
               <div class="wp">
                    <div class="fdown cle">
                         <h4 class="tit">Click the button to download the Mr. menu application</h4>
                         <div class="nr">
                              <?php $_result=get_news(23,32,0,0,'*',3);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a download="<?php echo ($v["file1"]); ?>" href="<?php echo ($v["file1"]); ?>"><img src="<?php echo ($v["img1"]); ?>" alt="" class="tp rd6">
                                   <div class="hdownLay">
                                        ...
                                        <h4 class="tit2">Scan code to try</h4>
                                   </div>
                    ...
                    <div class="fnav">
                         <ul class="fnavul cle">
                              ...
                              <li>
                                   <h4 class="ftit b">Customer support</h4>
                                   <div class="nr2">
                              ...
                              <li>
                                   ...
                                   <div class="nr1">
                                        <p class="p1">Cooperation：<?php echo sys('sys_gz');?></p>
                                        <p class="p1">Recruitment：<?php echo sys('sys_zp');?></p>
                                   </div>
                              </li>
                         </ul>
                    </div>
