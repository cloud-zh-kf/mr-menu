...
<body>
                         ...
                         <div class="wp clearfix">
                              ...
                              <nav class="nav">
                                   <ul class="wp navul">
                                        ...
                                        <li><a href="javascript:;" <?php echo $vpid==18 ? 'class="act_nav"':''; echo $vpid==35 ? 'class="act_nav"':''; ?>>ABOUT US<i class="iconfont icon-down2"></i></a>
                                             <div class="subnav zj">
                                                  <div class="nr">
                                                    <a href="index.php?m=&c=List&a=About&pid=35&ty=37&tty=0" >Unsere Vision
                                                    </a>
                              ...
                              <div class="chooseLan rd30">
                                   <div class="curLan">
                                        ...
                                        <span class="val ibvm">German</span></div>
                                   <div class="lanLay">
                                        <ul class="lanul cle">
    ...
    <div class="i_main mt20">
        <div class="wp">
           <div class="cooDel">
               <ul class="cooDelul">
                    <?php $_result=get_case($id,$vty,$vtty,0,'*',1000);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                         <div class="tparea"><img src="<?php echo ($v["img1"]); ?>" alt="" class="tp"></div>
                         <div class="des">
                             <h4 class="tit"><?php echo ($v["title"]); ?></h4>
                             <div class="nr"><?php echo get_html($v['content']);?></div>
                         </div>
