...
<body>
              ...
              <header  id="mainMenuBar" class="header iheader"><?php endif; ?>
                  <div class="loarea">
                         <div class="wp clearfix">
                              <a class="logo" href="/de/"><img src="<?php echo sys('sys_img1');?>" /></a>
                              <!--PC nav -->
                              <nav class="nav">
                                   <ul class="wp navul">
                                        <li><a <?php echo empty($vpid) ? 'class="act_nav"':''; ?> href="/de/">HOME</a></li>
                                        ...
                                        <li><a href="javascript:;" <?php echo $vpid==18 ? 'class="act_nav"':''; echo $vpid==35 ? 'class="act_nav"':''; ?>>Über uns<i class="iconfont icon-down2"></i></a>
                                             <div class="subnav zj">
                                                  <div class="nr">
                                                    <a href="index.php?m=&c=List&a=About&pid=35&ty=37&tty=0" >UNSER VISION
                                                    </a>
                                                    <a href="index.php?m=&c=List&a=common&pid=18&ty=21&tty=0" ><?php echo get_sort_zd(21);?></a>
                                                    <a href="index.php?m=&c=List&a=message&pid=18&ty=22&tty=0" >ÜBER DIE ZUSAMMENARBEIT</a>
                                                  </div>
                                             </div>
                                        </li>
                                   </ul>
                              ...
                              <div class="chooseLan rd30">
                                   <div class="curLan">
                                        ...
                                        <span class="val ibvm">Deutsch</span></div>
                                   <div class="lanLay">
                                        <ul class="lanul cle">
                              ...
                              <div class="inav">
                                   <div class="wrap">
                                        ...
                                        <dl>
                                             ...
                                             <dd>
                                             <h6><a href="index.php?m=&c=List&a=About&pid=35&ty=37&tty=0" >UNSER VISION</a></h6>
                                             <h6><a href="index.php?m=&c=List&a=common&pid=18&ty=21&tty=0" ><?php echo get_sort_zd(21);?></a></h6>
                                             <h6><a href="index.php?m=&c=List&a=message&pid=18&ty=22&tty=0" >ÜBER DIE ZUSAMMENARBEIT</a></h6>
                                             </dd>
                                        </dl>
                                   </div>
                              </div>
                                        ...
                                        <div class="mandiv">
                                          <!-- popupVideo1 -->
                                             <a href="<?php echo get_url($v['id'],'List','video');?>" class=" sbtn_ban btn rd40">
                                                  <span class="val">mehr über Mr. Menu erfahren
</span>
    ...
    <div class="i_main mt20">
       <div class="wp">
            <h4 class="i_tit tc"><?php echo get_sort_zd(16);?></h4>
            <div class="join wp">
                <dl class="joindl">
                    <?php $_result=get_news(4,16,0,0,'*',1000);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dt act="<?php echo ($v["title"]); ?>"><?php echo ($v["title"]); ?><em class="status"><i class="iconfont icon-down2"></i></em></dt>
                        <dd>
                            <div class="joinnr clearfix">
            ...
            <!-- 问题反馈 -->
            <form method="post" action="index.php?m=Home&c=List&a=message" style="display: none;" id="wtfk">
                <div class="qusForm">
                    <h4 class="i_tit tc">Problem Feedbacka</h4>
                <div class="feedback">
                    <input type="hidden" name="typeid" value="2">
                    <input type="hidden" name="cjwt" value="Problem feedback" class="wtfk">
                    <div class="item" id="wordCount">
                        <textarea name="message" required="" oninvalid="setCustomValidity('Bitte geben Sie Ihre Rückmeldung ein / Absicht der Zusammenarbeit\n')" oninput="setCustomValidity('')" id="" placeholder="Bitte geben Sie Ihre Rückmeldung /Kooperationsabsicht ein" class="textarea rd10"></textarea>
                        <span class="lastNum"><span class="word">1000</span>/1000</span>
                    </div>
                    <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('Bitte geben Sie einen Namen ein')" oninput="setCustomValidity('')" name="name" placeholder="Namen" class="text rd10">
                        </div>
                        <div class="item">
                            <input type="number" required="" oninvalid="setCustomValidity('Bitte geben Sie die Kontaktdaten ein')" oninput="setCustomValidity('')" placeholder="Kontakt Informationen" id="tel" name="tel" class="text rd10">
                            <!-- 默认不显示提示 -->
                            <div class="msg"></div>
                        </div>
                        <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('Bitte E-Mail eingeben')" oninput="setCustomValidity('')" name="email" id="email" placeholder="Postfach" class="text rd10">
                            <div class="msg"></div>
                        </div>
                    <div class="item tj tc">
                        <input type="submit" value="einreichen" class="sbtn btn rd40 sbtn_green btn_tj">
                    </div>
                </div>
                <script>
                        // 问题反馈
            ...
            <!-- 意见反馈 -->
            <form method="post" action="index.php?m=Home&c=List&a=message" style="display: block;" id="yjfk">
                <div class="qusForm">
                    <h4 class="i_tit tc">Feedback</h4>
                <div class="feedback">
                    <input type="hidden" name="cjwt" value="Feedback">
                    <input type="hidden" name="typeid" value="2">
                    <div class="item" id="wordCount">
                        <textarea name="message" required="" oninvalid="setCustomValidity('Bitte geben Sie Ihre Rückmeldung ein / Absicht der Zusammenarbeit')" oninput="setCustomValidity('')" id="" placeholder="Bitte geben Sie Ihre Rückmeldung /Kooperationsabsicht ein " class="textarea rd10"></textarea>
                        <span class="lastNum"><span class="word">1000</span>/1000</span>
                    </div>
                    <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('Bitte geben Sie einen Namen ein')" oninput="setCustomValidity('')" name="name1" placeholder="Namen" class="text rd10">
                        </div>
                        <div class="item">
                            <input type="number" required="" oninvalid="setCustomValidity('Bitte geben Sie die Kontaktdaten ein')" oninput="setCustomValidity('')" placeholder="Kontakt Informationen" id="tel1" name="tel" class="text rd10">
                            <!-- 默认不显示提示 -->
                            <div class="msg"></div>
                        </div>
                        <div class="item">
                            <input type="text" required="" oninvalid="setCustomValidity('Bitte E-Mail eingeben')" oninput="setCustomValidity('')" name="email" id="email1" placeholder="Postfach" class="text rd10">
                            <div class="msg"></div>
                        </div>
                    <div class="item tj tc">
                        <input type="submit" value="einreichen" class="sbtn btn btn_bb rd40 sbtn_green">
                    </div>
                </div>
                <script>
                        // 问题反馈
    ...
    <script type="text/javascript">
           $('.btn_bb').click(function(){
                ...
                var dh=/^[0-9][0-9][0-9]{11}$/;
                    ...
                    if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                            $('#yjfk #tel1').focus();
                            $('#yjfk #tel1').next('.msg').html('Das Format Ihrer Mobiltelefonnummer ist falsch！');
                            return false;
                          }else{
                            $('#yjfk #tel1').next('.msg').html('');
                          }

                        if(!email.match(/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/))
                        {
                           $('#yjfk #email1').next('.msg').html('Falsches Format!Bitte erneut eingeben');
                           $("#yjfk #email1").focus();
                            return false;
                        }else{
                           $('#yjfk #email1').next('.msg').html('');
                        }
     ...
     <script type="text/javascript">
           $('.btn_tj').click(function(){
                ...
                if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                            $('#wtfk #tel').focus();
                            $('#wtfk #tel').next('.msg').html('Das Format Ihrer Mobiltelefonnummer ist falsch！');
                            return false;
                          }else{
                            $('#wtfk #tel').next('.msg').html('');
                          }

                        if(!email.match(/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/))
                        {
                           $('#wtfk #email').next('.msg').html('Falsches Format!Bitte erneut eingeben');
                           $("#wtfk #email").focus();
                            return false;
                        }else{
                           $('#wtfk #email').next('.msg').html('');
                        }
    ...
    $(document).ready(function() {
     ...
     <div class="footer" id="xz">
          <div class="f_t">
               <div class="wp">
                    <div class="fdown cle">
                         <h4 class="tit">Klicken Sie auf die Schaltfläche, um die Mr. Menü-Anwendung herunterzuladen</h4>
                         <div class="nr">
                              <?php $_result=get_news(23,32,0,0,'*',3);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a download="<?php echo ($v["file1"]); ?>" href="<?php echo ($v["file1"]); ?>"><img src="<?php echo ($v["img1"]); ?>" alt="" class="tp rd6">
                                   <div class="hdownLay">
                                        ...
                                        <h4 class="tit2">Scannen von Code zum Versuch</h4>
                                   </div>
                    ...
                    <div class="fnav">
                         <ul class="fnavul cle">
                              ...
                              <li>
                                   <h4 class="ftit b">Unterstützung der Kunden</h4>
                                   <div class="nr2">
                              ...
                              <li>
                                   ...
                                   <div class="nr1">
                                        <p class="p1">Zusammenarbeit:<?php echo sys('sys_gz');?></p>
                                        <p class="p1">Einstellung:<?php echo sys('sys_zp');?></p>
                                   </div>
                              </li>
                         </ul>
                    </div>
          ...
          <div class="f_b">
               <div class="copyright tc"><?php echo sys('sys_copyright');?>
                    ...
                    <a href="http://www.9-xin.com" style="margin-left:5px;color:#fff" target="_blank">Technische Unterstützung: Jiuxin Netzwerk</a>
               </div>
          </div>
     </div>
     <!--底部-->
          <div class="floatpart">
               <ul class="floatpartul">
                    ...
                    <li ><a href="javascript:;" class="messbtn"><img src="./images/icon/side02.png" alt="" class="tp"></a>
                         <div class="messlay">
                                   <form class="hmform" method="post" action="index.php?m=Home&c=List&a=message"><h4 class="tit">Konsultation zur Zusammenarbeit
                                          </h4>
                                        <input type="hidden" name="typeid" value="5">
                                        <div class="item">
                                             <div class="attrmc">Namen
                                                            <i class="require">*</i></div>
                                             <div class="attrval"><input placeholder="Namen
" required oninvalid="setCustomValidity('Bitte geben Sie den richtigen Kontaktnamen ein')" oninput="setCustomValidity('')" type="text" name="username" id="username" class="text rd10">
                                                  <!-- <div class="msg"></div> -->
                                             </div>
                                        </div>
                                        <div class="item">
                                             <div class="attrmc">Kontakt Informationen
                                                            <i class="require">*</i></div>
                                             <div class="attrval"><input placeholder="Contact information
" required oninvalid="setCustomValidity('Bitte geben Sie die Kontaktdaten ein')" oninput="setCustomValidity('')" type="number" name="tel" id="tel" class="text rd10">
                                                  <div class="msg"></div>
                                             </div>
                                        </div>
                                        <div class="item">
                                             <div class="attrmc">Land
                                                            <i class="require">*</i></div>
                                             <div class="attrval">
                                        ...
                                        <div class="item">
                                             <div class="attrmc">Name des Restaurants
                                                            <i class="require">*</i></div>
                                             <div class="attrval"><input placeholder="Restaurant name
" required oninvalid="setCustomValidity('Bitte geben Sie den Namen des Restaurants ein')" oninput="setCustomValidity('')" type="text" name="name" id="name" class="text rd10">
                                                  <!-- <div class="msg">Please enter the correct surname restaurant name</div> -->
                                             </div>
                                        </div>
                                        <div class="item">
                                             <div class="attrmc">Adresse des Restaurants
                                                            <i class="require">*</i></div>
                                             <div class="attrval">
                                                  <textarea  class="textarea" name="add" required oninvalid="setCustomValidity('Bitte geben Sie die Adresse des Restaurants ein')" oninput="setCustomValidity('')" placeholder="Adresse des Restaurants
" id="add" cols="30" rows="10"></textarea>
                                                  <!-- <div class="msg">Please enter the correct Restaurant Address</div> -->
                                             </div>
                                        </div>
                                        <div class="item tj tc"><input class="sbtn rd40 btn sbtn_green hmformBtn" type="submit" value="einreichen
" /></div>
                                   </form>
                                   <script type="text/javascript">
                                        $('.hmformBtn').click(function(){
                                             ...
                                             if(tel.val() && username){
                                                  if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                                                    $('.hmform #tel').focus();
                                                    $('.hmform #tel').next('.msg').html('Das Format Ihrer Mobiltelefonnummer ist falsch！');
                                                    return false;
                                                  }else{
                                   ...
                                   <div class="subAchieve">
                                        <h4 class="tit">Konsultation zur Zusammenarbeit
                                                </h4>
                                        <div class="nr">
                                             <div class="tp"><i class="iconfont icon-jinakangbaoicons17"></i></div>
                                             <p class="p1">Vorlage erfolgreich
                                                            <br>Wir werden Sie bald kontaktieren
                                                            ～</p>
                                        </div>
                                        <div class="tj tc">
                    ...
                    <li class="codeBtn"><a href="javascript:;"><img src="./images/icon/side03.png" alt="" class="tp"></a>
                         <div class="codeLay">
                              ...
                              <p class="tit">Öffentliche Rechnung vonHerr Menu
                                    </p>
                         </div>
                    </li>
                    <li class="codeBtn"><a href="javascript:;"><img src="./images/icon/side04.png" alt="" class="tp"></a>
                         <div class="codeLay">
                                   ...
                                   <p class="tit">Weibo vonHerr Menu
                                          </p>
                              </div>
                    </li>
                    <li class="codeBtn"><a href="javascript:;"><img src="./images/icon/side05.png" alt="" class="tp"></a>
                         <div class="codeLay">
                                   ...
                                   <p class="tit">Tiktok vonHerr Menu
                                          </p>
                              </div>
