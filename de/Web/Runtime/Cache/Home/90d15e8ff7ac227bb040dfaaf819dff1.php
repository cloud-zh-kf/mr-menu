   ...
   <div class="imain2 bcover" style="background-image: url(./images/cooG_bg.png);">
        ...
        <div class="wrap">
                <div class="wrap2">
                        <div class="cooGrasp">
                             <div class="i_tit3 tc">
                                 <h4 class="tit">Mr.Menu Zusammenarbeit</h4>
                                 <p class="tip">
                                     Bitte füllen Sie das untenstehende Formular aus und wir werden Ihnen antworten, sobald wir Ihre Anfrage erhalten haben.
                                 </p>
                             </div>
                             ...
                             <div class="form">
                                 ...
                                 <div class="field1">
                                    <div class="item">
                                        <div class="attrmc">Name des Restaurants<i class="require">*</i></div>
                                        <div class="attrval">
                                            <input type="text" name="name" id="name" required oninvalid="setCustomValidity('Bitte geben Sie den Namen des Restaurants ein')" oninput="setCustomValidity('')"  class="text rd10">
                                            <!-- <div class="msg" style="display:none;">Please enter the correct restaurant name</div> -->
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Art des Restaurants<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="type" id="type" oninvalid="setCustomValidity('Bitte Restaurant eingeben')" oninput="setCustomValidity('')"   required  class="text rd10">
                                            <!-- <div class="msg">Please enter the correct restaurant type</div> -->
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Adresse des Restaurants<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="add" id="add" oninvalid="setCustomValidity('Bitte geben Sie die Adresse des Restaurants ein')" oninput="setCustomValidity('')"   required  class="text rd10">
                                 ...
                                 <div class="field2">
                                    <div class="item">
                                        <div class="attrmc">Postfach<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="email" id="email" oninvalid="setCustomValidity('Bitte geben Sie die E-Mail an')" oninput="setCustomValidity('')"  required class="text rd10">
                                            <div class="msg"></div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Tel<i class="require">*</i></div>
                                        <div class="attrval"><input type="number" name="tel" id="tel" oninvalid="setCustomValidity('Bitte geben Sie die Telefonnummer ein')" oninput="setCustomValidity('')"  required class="text rd10">
                                            <div class="msg"></div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="attrmc">Name des Kontakts<i class="require">*</i></div>
                                        <div class="attrval"><input type="text" name="username" required  id="" oninvalid="setCustomValidity('Bitte geben Sie den Kontaktnamen ein')" oninput="setCustomValidity('')"  class="text rd10">
...
" class="rd10 sbtn sbtn_green btn rd40">
                                   ...
                                   $('.btn').click(function(){
                                        ...
                                        var dh=/^[0-9][0-9][0-9]{11}$/;
                                            if(email){
                                                ...
                                                {
                                                   $('.form #email').next('.msg').html('Falsches Format!Bitte erneut eingeben');
                                                   $(".form #email").focus();
                                                    return false;
                                                }else{
                                                ...
                                                if (!(zz.test(tel.val()) || dh.test(tel.val()))) {
                                                    $('.form #tel').focus();
                                                    $('.form #tel').next('.msg').html('Das Format Ihrer Mobiltelefonnummer ist falsch！');
                                                    return false;
                                                  }else{
