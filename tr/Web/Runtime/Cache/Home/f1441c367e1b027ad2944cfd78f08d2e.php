       ...
       <div class="wp">
            ...
            <div class="favCase">
                <ul class="hcaseul cle">
                  <?php $_result=get_news_fy(6,23,29);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                         <a href="javascript:;">
                              <div class="intro cle">
               ...
               <!-- turnpage -->
                <div class="turnpage">
                    ...
                    <em class="go">到第<input type="text" name="page" value="<?php echo $_GET['p'] ? $_GET['p']:1;?>" class="num">頁</em>
                    <input type="submit" class="tj fytj" value="確定">
                </div>
            </div>
       </div>
    </div>
