                                ...
                                <div class="subnav">
                                    <dl class="clearfix">
                                        <?php $_result=get_sort_list(1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dd <?php if($v['id']==$vty) echo 'class="on"';?>>
                                            ...
                                            </dd><?php endforeach; endif; else: echo "" ;endif; ?></dd>
                                    </dl>
                                </div>
                            </li>
...
<div class="recruitxq zhd">
    <div class="wp">
          <div class="recrxtop">招聘岗位</div>
          <div class="tdjlcon">
              <p>东联和信（阜阳）学校现面向全国优秀教师及优秀高校应届生（双一流大学、安徽本地优秀师范院校）招聘初中各科老师50人，工作地点为安徽省阜阳市经济技术开发区。</p>
              <div class="tdjl">
         ...
         <div class="tdtable">
              <table>
                  ...
                  <?php $_result=get_news(6,20,0,0,'*',20);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                     ...
                     <td>
                         ...
                         <form action="<?php echo U('List/Up');?>" method="post" enctype="multipart/form-data">
                             ...
                             <a href="javascript:;"  class="tdbtn click_edg_img<?php echo ($i); ?>">
                                 <img src="images/recry.png" class="inbk">投递简历
                                 <input type="file" name="files" id="edg_file_buttom<?php echo ($i); ?>" class="tdfile">
                                 <input type="submit" value="" id="change_profile_photo<?php echo ($i); ?>" name="change_profile_photo" style="opacity:0">
                             </a>
                         </form>
                     </td>
                     <td><a href="<?php echo get_url($v['id'],'List','VRecruitment');?>">查看详情</a></td>
...
<script>
    $(function () {
         <?php $_result=get_news(6,20,0,0,'*',20);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>$(".click_edg_img<?php echo ($i); ?>").click(function () {
            $("#edg_file_buttom<?php echo ($i); ?>").change(function () {
                $("#change_profile_photo<?php echo ($i); ?>").click();
            })
