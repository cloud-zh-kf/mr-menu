...
<body>
    ...
    <div class="i_main mt20">
       <div class="wp">
            ...
            <div class="join wp">
                <dl class="joindl">
                    <?php $_result=get_news($vpid,$vty,0,0,'*',6);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dt><?php echo ($v["title"]); ?><em class="status"><i class="iconfont icon-down2"></i></em></dt>
                        <dd>
                            <div class="joinnr clearfix">
                                <?php echo get_html($v['content']);?>
                            </div>
                        </dd><?php endforeach; endif; else: echo "" ;endif; ?>
                    <!-- <dt>如何入驻？<em class="status"><i class="iconfont icon-down2"></i></em></dt>
                    <dd>
                        <div class="joinnr clearfix">
                            2
                        </div>
