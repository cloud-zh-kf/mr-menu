          ...
          <div class="contactwp">
               <div class="contact clearfix">
                    <div class="contactfl fl">
                         <iframe src="/Home-List-Map-pid-1-ty-11.html" width="100%" height="350" class="map"></iframe>
                    </div>
                    <div class="contactfr fr">
                         <h3>东联和信（阜阳）学校联系方式</h3>
                         <p><img src="images/contact01.jpg">咨询电话：<?php echo sys('sys_phone');?></p>
                         <p><img src="images/contact02.jpg">QQ： <?php echo sys('sys_qq');?></p>
                         <p><img src="images/contact03.jpg">邮箱： <?php echo sys('sys_email');?></p>
                         <p><img src="images/contact04.jpg">公司地址： <?php echo sys('sys_address');?></p>
                    </div> 
               </div>
          </div>
     </div>
