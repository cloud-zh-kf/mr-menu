...
<div class="joinlistop">
    ...
    <?php if($vty){?><a href="<?php echo get_nav_url($vpid,$vty);?>" class="on"> <?php echo get_sort_zd($vty);?></a><?php }?>
          ...
          <?php $_result=get_news(6,36,0,0,'*',1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="jointopfl">
...
<div class="jopostbg">
     <div class="wp">
          <ul class="clearfix">
             <?php $_result=get_sort_list(6,5,1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                <a href="<?php echo get_nav_url(6,$v['id']);?>">
                   <div class="postTop">
                        <div class="inbk imgW"><img src="<?php echo get_img($v['img2']);?>" class="img" width="70" height="70"></div>
                        <span><?php echo ($v["catname"]); ?></span>
                   </div>
                   <div class="postBot">
                        <?php echo nl2br($v['seodescription']);?>
                        <div class="tr"><span>详细>></span></div>
                   </div>
                </a>
