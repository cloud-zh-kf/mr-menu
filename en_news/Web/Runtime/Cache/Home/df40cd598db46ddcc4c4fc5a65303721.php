...
<div class="page">
    ...
    <div class="sidecontact"><?php echo sys('sys_address');?><br>
        ...
        <div class="main">
            <div class="newslist">
                <ul>
                    <?php $_result=get_news_fy(5);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo get_url($v['id'],'List','View');?>"><img src="<?php echo get_img($v['img1']);?>">
                        <h4><?php echo ($v['title']); ?></h4>
                        <p><?php echo get_content($v['content'],100);?></p>
                        <span>more+</span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
