...
<div class="wp">
     <div class="noticemx newbc">
          <ul class="clearfix">
              <?php ?>
              <?php $_result=get_sort_list($vpid,10,0);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if($i%2==0) echo 'class="notibn"'?>>
                 <a href="<?php echo get_nav_url($v['pid'],$v['id']);?>" class="boxW">
                    <div class="imgW inbk"><img src="<?php echo get_img($v['img2']);?>" class="img" width="500" height="210"></div>
                    <div class="mlW inbk">
                         <div class="noticon">
                              <h3><?php echo ($v["catname"]); ?></h3>
                              <div class="notinr"><?php echo nl2br($v['seodescription']);?></div>
                         </div>
                    </div>
                 </a>
