        ...
        <div class="main">
            <div class="productlist">
                <ul>
                    ...
                    <?php $_result=get_news_fy(9);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo get_url($v['id'],'List','Show');?>"><img src="<?php echo get_img($v['img1']);?>">
                            <h4><?php echo ($v['title']); ?></h4>
                            <span></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
