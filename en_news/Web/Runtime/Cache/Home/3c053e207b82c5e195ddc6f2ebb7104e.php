            ...
            <div class="message">
                ...
                <script>
                    ...
                    function check_myforms(formlist){
                        if(checkspaces(formlist.title.value)){
                            alert('请输入标题');
                            formlist.title.focus();
                            return false;
                        }
                        if(checkspaces(formlist.realname.value)){
                            alert('请输入姓名');
                ...
                <form name="myform" method="post" action="/Home-List-Message" onSubmit="return check_myforms(this)">
                    <input type="hidden" name="typeid" value="1">
                    <ul class="list-none">
                        <li>
                            标 题： <input name="title" type="text" class="input" id="GuestBook_Title" />
                            <span id="ReqTitle" style="color:Red;">*</span></li>
                        <li>
                            姓 名： <input name="realname" type="text" class="input" id="GuestBook_UserName"/>
                            <span id="ReqTitle" style="color:Red;">*</span></li>
                        <li>电 话： <input name="tel" type="text" class="input" id="GuestBook_UserTel"/>
                            <span id="ReqUserTel" style="color:Red;">*</span></li>
                        <li>邮 箱： <input name="email" type="text" class="input" id="GuestBook_UserEmail"/>
                            <span id="ReqUserEmail" style="color:Red;">*</span></li>
                        <li>留 言： <textarea name="message" class="textarea" id="GuestBook_Content" ></textarea>
                            <span id="ReqContent" style="color:Red;">*</span></li>
                        <li class="button">
                            <input type="submit" value="提交留言" class="submit" /></li>
