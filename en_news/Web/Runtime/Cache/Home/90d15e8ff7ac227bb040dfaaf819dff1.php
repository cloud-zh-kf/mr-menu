                ...
                <div class="wrap2">
                        <div class="cooGrasp">
                             ...
                             <div class="form">
                                 ...
                                 <div class="item">
                                     <div class="attrmc">What are your needs?
                                         <i class="require">*</i></div>
                                     <div class="attrval">
                                         <div class="seltype" id="seltype">
                                             <div class="list"><input type="radio" value="3" name="typeid" class="radio" id="">Restaurant cooperation
                                             </div>
                                             <div class="list"><input type="radio" value="4" name="typeid" class="radio" id="">Other
                                             </div>
                                         </div>
                                     </div>
                                 </div>
                                 <div class="field1">
                                    ...
                                    <div class="item">
                                        <div class="attrmc">Restaurant type
                                            <i class="require">*</i></div>
...
" class="rd10 sbtn sbtn_green btn">
