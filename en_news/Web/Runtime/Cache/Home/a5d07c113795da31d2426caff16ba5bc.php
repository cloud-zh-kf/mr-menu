...
<body>
     ...
     <div class="h_man">
          <div class="wp">
               <div class="h_tit">
                    <h4 class="tit tc">Product features
                    </h4>
               </div>
               <ul class="hmanul cle">
                    <?php $_result=get_news(23,33,0,0,'*',100);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                              <a>
                                   <span class="tparea"><img alt="" class="tp" src="<?php echo ($v["img1"]); ?>"></span>
                                   <div class="des">
                                        <h4 class="tit"><?php echo ($v["title"]); ?></h4>
                                        <p class="nr"><?php echo get_nl2br($v['introduce']);?></p>
                                   </div>
                              </a>
     ...
     <!-- 扫码试用 -->
     <div class="h_scan bcover" style="background-image: url(./images/h_san_bg.png);">
          <div class="wp">
               <div class="h_tit h_tit_w">
                    <h4 class="tit tc">Scan code to try
                    </h4>
               </div>
               <div class="wrap tc">
                    <img src="<?php echo sys('sys_img4');?>" alt="" class="tp rd5">
                    <p class="p1">【Welcome to click the "About cooperation" below to join Mr.Menu after trial
                         】</p>
                    <div class="mandiv tc">
                         <a href="javascript:;" class="hscanBtn rd40 sbtn sbtn_green">About cooperation
                         </a>
                    </div>
               </div>
          </div>
     ...
     <!-- 如何入驻Mr. Menu? -->
     <div class="h_settled mt10">
          <div class="wp">
               <?php $_result=get_news(23,27,0,0,'*',1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="h_tit">
                         <h4 class="tit tc"><?php echo ($v["title"]); ?></h4>
                    </div>
                    <div class="wrap tc">
     ...
     <div class="h_data">
          <div class="wp">
               <div class="h_tit">
                    <h4 class="tit tc"><?php echo get_sort_zd(28);?></h4>
                    <p class="tip tc"><?php echo get_sort_zd(28,'seotitle');?></p>
               </div>
               <div class="wrap tc">
                    <ul class="hdataul cle">
                         <?php $_result=get_news(23,28,0,0,'*',4);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
     ...
     <!-- 好评案例 -->
     <div class="h_case bg_f9">
          <div class="wp">
               <div class="h_tit">
                    <h4 class="tit tc"><?php echo get_sort_zd(29);?></h4>
               </div>
               <div class="wrap ">
                    <ul class="hcaseul cle">
                         <?php $_result=get_news(23,29,0,0,'*',4);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                                   <a href="">
                                        <div class="intro cle">
     ...
     <div class="h_supp">
          <div class="wp">
               <div class="h_tit">
                    <h4 class="tit tc">Cities supported
                    </h4>
               </div>
               <style type="text/css">
                    .hsbox .area1{width:1230px;}
               </style>
               <div class="wrap">
                    <div class="hstab">
                         <div class="hstit">
                              <?php $_result=get_sort_list(3,8);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($i == 1): ?><span class="act_hs"><?php echo ($v["catname"]); ?></span>
                                   <?php else: ?>
                                        <span><?php echo ($v["catname"]); ?></span><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                         </div>
                         <div class="hscon">
                              <?php $_result=get_sort_list(3,8);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($i == 1): ?><div class="hsbox" style="display: block;">
                                             <div class="area1">
                                                  <ul class="area1ul cle">
                                                       <?php $_result=get_sort_list($v['id']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><li>
                                                                 <a href="<?php echo get_sort_url($v['pid'],$v['id'],$vv['id'],caselist);?>" class="bcover hsItem"
                                                                      style="background-image: url(<?php echo ($vv["img1"]); ?>);">
                                                                      <!-- <div class="cityName">Boston</div> -->
                                                                      <div class="shade">
                                                                           <span class="tag"><?php echo ($vv["catname"]); ?></span>
                                                                           <div class="nr">
                                                                                <?php echo get_html($vv['introduce']);?>
                                                                           </div>
                                                                      </div>
                                                                 </a>
                                                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                              ...
                              <!-- <div class="hsbox">2</div>
                              <div class="hsbox">3</div> -->
                         </div>
                    </div>
               </div>
               <div class="morediv mt30 tc">
                    <a href="index.php?m=&c=List&a=case&pid=3&ty=0&tty=0" class="sbtn sbtn_green_s btn"><span class="val">more</span><i
