...
<div class="page">
    ...
    <div class="sidecontact"><?php echo sys('sys_address');?><br>
        ...
        <div class="main">
            ...
            <div class="jobs">
                <table class="jobs" width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <th align="left" scope="col">岗位名称</th>
                    ...
                    <?php $_result=get_news($vpid,$vty,0,0,'*',1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        <td><a href="<?php echo get_url($v['id'],'List','Vjobs');?>"><?php echo ($v['title']); ?></a></td>
                        <td align="center"><?php echo ($v["tags"]); ?></td>
                        <td align="center"><?php echo ($v['source']); ?></td>
                        <td align="center"><?php echo get_time($v['sendtime'],'Y-m-d');?></td>
