<?php if (!defined('THINK_PATH')) exit(); $Custitle="申请入学"?>
<?php
...
<div class="signwp">
     <div class="wp">
          <div class="signbox">
               <div class="signTop dxyz clearfix">
                    <a href="">预约报名</a>
               </div>
               <div class="rxsq">
                     <table>
                         <form action="/" method="post" name="form1" onsubmit="return check_apply(this)">
                          <tr>
                             <td>学生姓名:</td>
                             <td><input type="text" name="xs_realname" class="signtxt"></td>
                          </tr>
                          <tr>
                             <td>父亲姓名:</td>
                             <td><input type="text" name="fq_realname" class="signtxt"></td>
                          </tr>
                          <tr>
                             <td>父亲电话:</td>
                             <td><input type="text" name="fq_tel" class="signtxt"></td>
                          </tr>
                          <tr>
                             <td>母亲姓名:</td>
                             <td><input type="text" name="mq_realname" class="signtxt"></td>
                          </tr>
                          <tr>
                             <td>母亲电话:</td>
                             <td><input type="text" name="mq_tel" class="signtxt"></td>
                          </tr>
                          <tr>
                             <td>就读学校:</td>
                             <td><input type="text" name="school" class="signtxt"></td>
                          </tr>
                          <tr>
                             <td>备注信息:</td>
                             <td><textarea class="signtxt sigtar" name="message"></textarea></td>
                          </tr>
                          <tr>
                             <td></td>
                             <td><button class="siglobtn">提交报名信息</button></td>
                          </tr>
                         </form>
                     </table>
               </div>
               <div class="yybmbot clearfix">
                    <a href="/User-Reg-pid-5-ty-19.html">
                       <img src="images/zh01.jpg">
                       <p>账号注册</p>
                    </a>
                    <a href="/User-Login-pid-5-ty-19.html">
                       <img src="images/zh02.jpg">
                       <p>账号登录</p>
                    </a>
               </div>
