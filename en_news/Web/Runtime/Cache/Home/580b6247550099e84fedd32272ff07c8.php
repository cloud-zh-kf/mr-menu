...
<!--banner end-->
<?php }else{ $tmp_pid=I('get.pid',0); $tmp_ty=I('get.ty',0); $tmp_tty=I('get.tty',0); if($tmp_pid&&$tmp_ty&&$tmp_tty) $myids=$tmp_tty;elseif($tmp_pid&&$tmp_ty&&$tmp_tty==0) $myids=$tmp_ty;if($tmp_pid&&$tmp_ty==0) $myids=$tmp_pid; ?>
<div class="nrban">
...
<div class="academiczg">
     <h3 class="zgtit">总顾问</h3>
     <?php $_result=get_news(1,10,32,0,'*',1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="acsdzg">
          <div class="wp clearfix">
               <div class="inteamfl fl">
                  <img src="<?php echo get_img($v['img1']);?>">
               </div>
               <div class="inteamfr fr">
                    <div class="inteamtitle">
                         <h3><?php echo ($v["title"]); ?></h3>
                         <span><?php echo ($v["tags"]); ?></span>
                    </div>
                    <div class="inteamcon"><?php echo nl2br($v['introduce']);?></div>
               </div>
          </div>
     </div><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
<!-- 专家成员 -->
<div class="expertbox">
     <h3 class="zgtit">专家成员</h3>
     <div class="wp">
          <div class="inacadmain">
               <ul class="clearfix">
                   <?php $_result=get_news(1,10,33,0,'*',6);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                       <a href="javascript:;">
                            <div class="imgW inbk"><img src="<?php echo get_img($v['img1']);?>" class="img" width="480" height="307"></div>
                            <div class="inacacon">
                                 <h3><?php echo ($v["title"]); ?><span><?php echo ($v["tags"]); ?></span></h3>
                            </div>
                       </a>
                       <div class="cabr">
                             <?php echo nl2br($v['introduce']);?>
                       </div>
