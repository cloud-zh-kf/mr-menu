...
<body>
    ...
    <div class="i_main mt20">
        <div class="wp">
            <?php $_result=get_news(23,30,0,0,'*',1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><h4 class="i_tit tc"><?php echo ($v["title"]); ?></h4>
                <div class="videoDel tc">
                    <video class="videoBox rd10" controls>
