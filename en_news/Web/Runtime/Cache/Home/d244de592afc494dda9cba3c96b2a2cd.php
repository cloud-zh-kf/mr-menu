...
<div class="wp">
     <div class="noticemx newbc">
          <ul class="clearfix">
              <?php $_result=get_news_fy(6);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if($i%2==0) echo 'class="notibn"'?>>
                 <a href="<?php echo get_url($v['id'],'List','View');?>" class="boxW">
                    <div class="imgW inbk"><img src="<?php echo get_img($v['img1']);?>" class="img" width="500" height="210"></div>
                    <div class="mlW inbk">
                         <div class="noticon">
                              <h3><?php echo ($v["title"]); ?></h3>
                              <div class="notinr"><?php echo get_content($v['content'],100);?></div>
                         </div>
                    </div>
                 </a>
