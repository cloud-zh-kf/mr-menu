...
<?php if($vpid==0){?>
    <div class="index_focus">
        <div class="bd">
            <ul class="list-none">
                <?php $_result=get_news(9,31,0,0,'*',10);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><img src="<?php echo get_img($v['img1']);?>" width="100%"></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
    ...
    <div class="sidecontact"><?php echo sys('sys_address');?><br>
        ...
        <div class="main">
            <div class="down-list">
                ...
                <ul class="list-none">
                    <li><span class="name">文件名</span> <span class="time">上传日期</span> <span class="down">下载</span></li>

                    <?php $_result=get_news_fy(10);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($v['file1']); ?>" target="_blank"><span class="name"><?php echo ($v['title']); ?></span><span class="time"><?php echo get_time($v['sendtime'],'Y-m-d');?></span> <span class="down">&nbsp;</span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
