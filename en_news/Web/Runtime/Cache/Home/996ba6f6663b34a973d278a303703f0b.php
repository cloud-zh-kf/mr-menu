...
<div class="wp">
     <div class="noticemx">
          <ul class="clearfix">
              <?php $_result=get_news($vpid,$vty,$vtty,0,'*',5);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if($i%2==0) echo 'class="notibn"'?>>
