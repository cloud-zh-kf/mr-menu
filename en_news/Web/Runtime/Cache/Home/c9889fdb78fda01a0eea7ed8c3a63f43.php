...
<div class="page">
    ...
    <div class="sidecontact"><?php echo sys('sys_address');?><br>
        ...
        <div class="main">
            <div class="jobn">
                <?php $_result=get_view($id);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><h4 class="title"><?php echo ($v['title']); ?></h4>
                <div class="info"><strong>工作地点：</strong><?php echo ($v['source']); ?> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; <strong>发布时间：</strong><?php echo get_time($v['sendtime'],'Y-m-d');?> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; <strong>截止时间：</strong><?php echo ($v['author']); ?>&nbsp;&nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;&nbsp;<strong>招聘人数：</strong><?php echo ($v['tags']); ?></div>

                <h5><strong>应聘条件</strong></h5>
                     <?php echo get_html($v['content']);?>
                <h5><strong>职位说明</strong></h5>
                        <?php echo get_html($v['introduce']);?>
                <h5><strong>联系方式</strong></h5>
                <span style="color:#005bac;">
                    <p><span style="font-family: arial, helvetica, sans-serif;"><?php echo ($v['price']); ?></span></p>
