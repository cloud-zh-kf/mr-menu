...
<div class="profilbg">
    ...
    <?php if($vty){?><a href="<?php echo get_nav_url($vpid,$vty);?>" class="on"> <?php echo get_sort_zd($vty);?></a><?php }?>
          ...
          <?php $_result=get_news(7,30,0,0,'*',1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="glteam">
...
<!-- 团队介绍 -->
<div class="teambox">
     <?php $_result=get_news(1,9,I('get.tty',0),0,'*',3);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="teammain <?php if($i%2==0) echo 'wit';?>">
          <div class="wp clearfix">
               <div class="inteamfl <?php if($i%2==1) echo 'fl';else echo 'fr'?>">
                    <img src="<?php echo get_img($v['img1']);?>">
               </div>
               <div class="inteamfr <?php if($i%2==1) echo 'fr';else echo 'fl'?>">
