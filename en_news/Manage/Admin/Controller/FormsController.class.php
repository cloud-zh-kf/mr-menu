...
class FormsController extends PurviewController {
    ...
    public function Infos($typeid){
        ...
        foreach ($list as $k=>$v){
            if($v['status']==1) $status="<a href=\"jxadmin.php?m=Admin&c=Forms&a=Audit&typeid={$typeid}&id={$v['id']}\"><img width=\"16\" height=\"16\" border=\"0\" alt=\"已启用\" src=\"/Manage/Admin/Public/images/p.png\"/></a>
";else $status="<a href=\"jxadmin.php?m=Admin&c=Forms&a=Audit&typeid={$typeid}&id={$v['id']}\"><img width=\"16\" height=\"16\" border=\"0\" alt=\"已查封\" src=\"/Manage/Admin/Public/images/x.png\"/></a>";
